...
2. Strategia di replicazione
    1. __Desossiribovirus a doppio filamento__: si replicano nel nucleo della cellula ospite (solo pochissimi hanno una propria RNApol che funziona nel citoplasma)
    2. __Desossiribovirus a singolo filamento__: viene sintetizzato un filamento complementare da una polimerasi cellulare, e si replicano usando il macchinario celulare
    3. \TODO{}
    ...
    7. __DNA cicrcolare__ parzialmente bicatenario
...
- Il capside _può_, a sua volta, presentare una membrana lipoproteica che avvolge il nucleocapside, detta \a{envelope}
...
- Sono tutti relativi ai processi di trascrizione del genoma o __proteasi virus-specifiche__^[A volte l'RNA virale viene trascritto per intero in un lungo filamento, che deve essere tagliato per diventare funzionale]
...
### Attacco del virione alla superficie cellulare
...
- Sono quindi 2 le caratteristiche fondamentali per la replicazione del virus
    - __Sensibilità__ della cellula al virus
    - __Permissività__ della cellula al suo ingresso
        ...
        - Infezione latente: cellula sensibile e permissiva, ma non permette la replicazione dei virioni

### Penetrazione del virus nella cellula
- Necessario un qualche "intervento attivo" da parte della cellula \marginnote{Il legame virus-recettore deve "convincere" la cellula a internalizzare il virus: è la cellula che decide cosa entra e cosa no}
...
- La metodica dipende dalla presenza o meno dell'envelope
    - Virus con envelope
        - Fusione dell'envelope con la membrana cellulare, e liberazione del nucleocapside all'interno
...
- In qualche modo deve essere liberato il genoma, rompendo il nucleocapside
    - O ci pensano proteasi cellulari
    - O intervengono direttamente proteasi virali
- Non molto chiaro in generale, ricerca in corso

### Sintesi delle macromolecole specifiche e replicazione del genoma
- L'obiettivo del virus è __produrre un mRNA per sfruttare la macchina traduzionale cellulare__ e, contemporaneamente, __duplicare il proprio genoma__
    - Siccome c'è una grande varietà di situazioni genomiche virali, il meccanismo specifico dipende dal virus

### Assemblaggio del virione prodotto e liberazione della progenie
- Obiettivo: liberare il virione. 2 strategie:
    1. Liberazione graduale per gemmazione e distacco: la cellula non muore e diventa "schiava" del virus. Tipica di virus con envelope
    2. Produzione massiccia non seguita da liberazione: la cellula fondamentalmente _esplode_ per il numero di virioni prodotti. Questa strategia è tipica di virus senza envelope

## Patogenicità
- Non ha senso in termini assoluti: è il risultato di una __combinazione__ di
    - __Patogenicità e virulenza del virione__
...
- Nel decidere la patogenicità si aggiunge anche la __modalità di risposta dell'host__
    - Infezioni virali solitamente inducono la __produzione di interferone__
    - `INF` portano ad una ↑ resistenza virale
    ...
    - Paradossalmente, a volte, il SI può essere parte del problema
        - Sovrastimolato dal virus, porta a danni ingenti -- e a volte letali -- per l'host (vedi ARDS da tempesta citochinica che provoca _coronavirus_)
...
# Virus oncogeni
- __Virus che, in seguito al contagio, promuovono la trasformazione delle cellule in senso neoplastico__
    - Il meccanismo principale è quello di produrre modificazioni genetiche \ini oncosoppressori e \att oncogeni
- Pochi i virus che hanno una _chiara correlazione_ con patologie cancerose
...
4. I linfociti B infetti vengono immortalizzati e modificati (fase latente)
    - Esprimono proteine nucleari `EBNA`
    - Esprimono \TODO{}
    - Perdono il controllo su `p53` e su `Rb`
5. SE si verificano eventi trasformanti endogeni o esogeni che _sigillano_ la trasformazione tumorale, comincia ad insorgere la patologia \marginnote{Solitamente eventi esogeni aumentano la probabilità di trasformazione, che viene sigillata da danni al genoma durante la replicazione}
    - Eventi esogeni: infezioni che ↑↑ il numero di linfociti per espansione clonale
...
- Molto raro, caratteristico solitamente dell'ultima fase di AIDS
    - Nel genoma del virus si trovano omologhi molecolari che stimolano la replicazione di cellule già infette dall'HIV
- \TODO{}
...
# Farmaci antivirali
- Il problema di colpire i virus è che si dovrebbero mettere a punto farmaci che interferiscano con la replicazione virale, ma non con la cellula: __hanno un indice terapeutico relativamente basso__
    - I primi antivirali erano molto tossici
    - I farmaci di ora sono molto migliorati, ma ancora hanno efficacia ridotta
        - Messi a punto con _random screening_^[I farmaci disponibili _per altri motivi_ (che quindi si sa che hanno una tossicità il più possibile ridotta) vengono provati _in vitro_ contro cellule infette]
...
- Sono solitamente __analoghi strutturali dei nucleosidi__: si sostituiscono ai nucleosidi ma non permettono legame di altri nucleosidi dopo di loro, andando di fatto a _bloccare_ la trascrizione
    - Derivati purinici
        - \far{acyclovir}^[Efficace solo contro HSV1, HSV2, VZV (varicella zoster), ma ha specificità notevole per DNApol virale (↓ tossicità)] e derivati: \far{ganciglovir}, \far{ribavirina}
...
- \far{ganciclovir}
    - Modificazione più potente (e tossica) dell'aciclovir, perché è meno selettivo e più attivo
- \far{ribavirina}
...
- Diverisi bersagli
    - Impedire l'__attacco__ dell'antirecettore (`gp120`) al recettore (e corecettori) dei linfociti, per impedire la fusione dell'envelope
    - Impedire la __retrotrascrizione__
        - Ovviamente super specifico e non tossico
    - Impedire la __trascrizione__
    - Impedire la formazione delle prteine con __proteasi__, bloccando di fatto l'assemblaggio della progenie
        - \TODO{}
...
- Efficacia limitata
    - IFN artificiale ha efficacia ridotta (l'organismo se ne libera molto in fretta^[Per questo l'IFN veniv _pegilato_, ovvero ricoperto di glicole polietilenico per ↑ tempo di eliminazione]) ⇒ ↑↑ dosi
