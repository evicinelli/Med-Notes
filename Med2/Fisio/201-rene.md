...
# Il rene
1. __Funzione escretrice__ (nei confronti di farmaci, ad esempio, anche se non è l'unica via di escrezione)
...
- Il nefrone è composto da diverse parti \marginfig{lblrenefro}
    ...
    3. \a{Ansa di Henle}, composta da 3 tratti
        ...
        Nei tratti spessi le cellule sono grandi e piene di mitocondri, per consentire trasporti attivi
    4. \a{Tubulo contorto distale}, sempre con cellule cuboidi e abbondanti di mitocondri
        - La parte terminale del tubulo distale si trova sempre in prossimità della biforcazione costruita dall'arrivo dell'arteriola afferente e dalla partenza dell'arteriola efferente al glomerulo
...
- Tutte le cellule tubulari, tranne quelle intercalate, presentano nel versante luminare un _ciglio primario_, che ha funzioni di sensore
...
- \art{arteria renale} > \art{arteria interlobale} > \art{arteria arcuata} > \art{arteria lobulare} > \art{arteriole afferenti} > \a{glomerulo renale} e rete capillare glomerulare > \art{arteriola efferente} > letto di capillari peritubulari > ritorno venoso \marginnote{Il ritorno venoso comincia dopo i capillari peritubulari, quindi \emph{dopo} l' \a{ansa di Henle}}
...
## Innervazione
- Fibre del __SNA__, prevalentemente _simpatiche_ provenienti dal plesso celiaco, secernenti noradrenalina e dopamina
    - Muscolatura liscia dei vasi
    - Cellule granulari dell'arteriola afferente ed efferente
    - Cellule tubulari
- SNA ⇒ `noradrenalina` e `dopamina`, che agiscono sopratutto su
...
- Necessari 3 processi
    1. Filtrazione glomerulare del plasma (_preurina_)
...
- Processo __passivo__ e non selettivo che prevede la __ultrafiltrazione del plasma__ per andare a produrre __preurina__. L'ultrafiltrazione avviene grazie ad una __membrana filtrante__
    ...
    - Le molecole vengono selezionate solo in accordo alle "qualità" della membrana filtrante
...
- I capillari vengono sostenuti da \a{cellule mesangiali} (o \a{cellule del mesangio})
    ...
    - Hanno _capacità contrattile_, per strizzare i capillari e aumentare l'ultrafiltrazione
    - Hanno _capacità fagocitaria_ e _producono prostaglandine_
- La filtrazione è espletata da una __membrana di filtrazione__ che circonda il capillare, costituita dalla collaborazione dell'__endotelio vasale__, di una __membrana basale__ e dei __\a{podociti}__, che abbracciano il capillare
    - L'endotelio dei capillari è _fenestrato_. Acqua e soluti passano sia tramite le fenestrature che tramite _pinocitosi_^[Trasporto dal lato del lume del vaso all'esterno del vaso mediante vescicole che attraversano l'endocita]
    - La _membrana basale_ è composta da varie proteine, organizzate a costruire una maglia di grandezza regolare. È questa maglia che agisce da _filtro_ in termini di dimensione molecolare
    - I _podociti_ espletano l'azione filtrante tramite i _pedicelli_
...
- La _membrana fitrante_ filtra passivamente i soluti sulla base delle caratteristiche fisiche delle molecole
    - __Dimensione__, in forza delle dimensioni delle fenestrature della maglia filtrante \marginfig{lbl-filtren}
        - Libera per soluti con pm \< 5000 dalton (ioni, glucosio, aa, urea...)
        - Parziale per soluti con 5000 \< pm \< 70000 dalton
        - Impedita per soluti con pm \> 70000 dalton
    - __Carica__, in forza del fatto che la membrana basale espone proteine con carica negativa
        ...
        - Anioni sono talmente piccoli che passano comunque
...
- A fronte di 1000 ml/min di flusso sanguigno che arriva al rene, il rene fisiologicamente __filtra al minuto circa il 20% della quota di plasma__^[FPR, Flusso Plasmatico Renale] ($VFG \simeq 125 ml/m$)^[Di fatto, il 20% del 60% (perché il plasma compone il sangue per 2/3) del 20% (perché complessivamente arriva al rene 1/5 del flusso sanguigno) dei 5 litri di sangue. Al minuto]
    ...
    - La frazione di filtrazione fisiologicamente si attesta attorno al 20%
...
- __Siccome la filtrazione è passiva, la frazione di filtrazione è determinata dalla differenza tra pressione idrostatica e pressione oncotica dei due versanti (glomerulare e capillare)__. La VFG è quindi definita anche attraverso la legge di Starling: $$\boxed{VFG=K(P_c - P_i) - (\pi_c - \pi_i)}$$
    - La filtrazione è possibile da una opportuna __pressione idrostatica__, che __nel capillare glomerulare permette un flusso netto in uscita__ verso la membrana di filtrazione. \TODO{Questo è garantito dall'arteriola afferente}
        - La pressione idrostatica glomerulare afferente (__P~c~__)è di __60 mmHg__, molto maggiore rispetto a quella dei capillari sistemici (35 mmHg). Questo è necessario perché nella capsula di Bowmann troviamo una pressione idrostatica di 15 mmHg, che è necessario vincere
        - La resistenza al flusso è bassa per via di un grande letto vascolare che mantiene fondamentalmente costante la resistenza tra versante arterioso e venoso. Questo permette una filtrazione _continua_, e non solo nel versante arterioso dei capillari. Quello che cambia è che nella parte venosa aumenta la pressione oncotica interna al capillare (perché le proteine sono maggiormente concentrate in seguito alla perdita di acqua avvenuta nel versante arterioso) -- ma l'aumento è minimo
        - __K~f~__ nei glomeruli è molto alto (x 100 rispetto ai capillari sistemici), deponendo definitivamente a favore di un flusso in uscita
...
- Il __principale fattore che decide la VFG è P~c~, a sua volta dipendente dalla pressione sistemica__, ma la __velocità di riassorbimento è assolutamente costante__. Sono quindi necessari meccanismi di compenso che __ammortizzino le normali variazioni della pressione arteriosa sistemica__^[La PA varia molto durante il giorno, non per forza secondo uno schema patologico: la variazione è consistente anche solamente se da sdraiati ci portiamo in piedi], altrimenti si avrebbero perdite di liquido enormi e incompatibili con la vita
    - In un range di PA media tra 80 e 180 mmHg il rene è capace di mantenere la VFG costante
    - __La pressione viene mantenuta costante mediante il controllo del calibro dell'arteriola afferente o efferente__
        - ↑ PA ⇒ ↓ calibro __afferente__ ⇒ ↑ resistenza a monte del glomerulo ⇒ ↓ pressione a livello del glomerulo
        - ↓ PA ⇒ ↓ calibro __efferente__ ⇒ ↑ resistenza a valle ⇒ ↑ pressione a livello del glomerulo
- 2 meccanismi per regolare il calibro dei vasi in funzione della pressione
    1. Feedback del tubulo glomerulare
...
- Il __muscolo liscio__ che le circonda risponde ad uno _stiramento_ (⇐ ↑ pressione del lume) con una __apertura dei canali per il Ca^++^__
    - ⇒ contrazione ⇒ ↓ diametro del lume ⇒ ↓ flusso ematico a valle del segmento contratto

#### Feedback del tubulo glomerulare
- L'apparato sensore delle variazioni di pressione è composto dalle \a{cellule juxtaglomerulari}, collocate tra nel triangolo costruito dalla parte terminale del tubulo distale, dall'arteriola efferente e dall'arteriola afferente^[Riferirsi all'anatomia del glomerulo]
    - \a{macula densa} -- cellule chemocettrici situate nella parete del tubulo, sensibili a variazioni di Na^+^ \marginnote{Il sodio diffonde liberamente attraverso la membrana filtrante. Una concentrazione anomala di sodio nel tubulo (↑ o ↓) è indice di anomalie nella filtrazione, specialmente a livello della VFG: siccome diffonde liberamente, l'unica cosa che decide la concentrazione di sodio dell'ultrafiltrato è il \emph{tempo di filtrazione}}
    - \a{cellule juxtaglomerulari} propriamente dette -- cellule specializzate dell'__arteriola efferente__. Hanno capacità contrattile e __producono `renina`__
    - \a{cellule del mesangio extraglomerulari}\ 
- Le cellule juxtaglomerulari __lavorano in concerto per regolare il calibro delle arteriole afferenti o efferenti__, mediante la secrezione di __sostanze paracrine__
    - ↑ NaCl ⇒ secrezione di `ATP` e `Adenosina` ⇒ vasocostrizione afferente e ↓ `renina`^[La renina è un enzima ad azione paracrina, che attiva `angiotensinogeno` → `angiotensina 1` $\xrightarrow{ACE\ dei\ capillari\ polmonari}$ `angiotensina 2` ⇒ vasocostrizione dell'arteriole]
    - ↓ NaCl ⇒ secrezione di `prostaglandine` e `NO` ⇒ vasodilatazione dell'arteriola afferente e ↑ `renina`
- A questo meccanismo si sovrappone un controllo prodotto dal SNS

<!--
\normalbox{}{
- L'arteriola __afferente__ esprime cospicuamente recettori per `PGE`~`2`~ e `NO`, che promuovono una sua dilatazione
- L'arteriola __efferente__ esprime cospicuamente recettori per `angiotensina 2`

Questo permette a queste arteriole di essere particolarmente sensibili a vasodilatatori e vasocostrittori che hanno normalmente un'azione _sistemica_: siccome esprimono una quota superiore alla media di recettori per queste sostanze, sono particolarmente sensibili
...
\TODO{immagine con 4 esempi}
- \TODO{}
    1. Filtrazione libera: solo una parte filtra liberamente, e la concentrazione nelle urine dipende dalla VFG
    2. Filtrazione _attiva_, con trasportatori attivi
    3. Filtrazione con _riassorbimento parziale_ a livello del tubulo distale, grazie a trasportatori attivi
    4. Filtrazione con _riassorbimento completo_ a livello del tubulo, grazie a trasportatori attivi molto efficai

#### Frazione filtrata e frazione escreta
- La roba non può sparire nel nulla: $$Concentrazione\ plasmatica \times VFG = Concentrazione\ urinaria \times flusso\ urinario$$ Posso quindi misurare la VFG in funzione del rapporto tra concentrazione urinaria e concentrazione plasmatica
- Le sostanze usate per misurare la VFG sono
    - __Inulina__ -- sostanza esogena che viene _completamente_ escreta con le urine
    - __Creatinina__^[In realtà un 10% viene secreto in altri modi, tuttavia la misura della creatinemia la sovrastima del 10%] -- \TODO{}

## Meccanismi di riassorbimento tubulare
\TODO{manca una lezione}
<!--
Mon 16 Mar 2020 11:18:43 AM CET
-->

\TODO{aggiungere dettagli in questa parte da sbobbe}

### Riassorbimento nel tubulo prossimale
- Il riassorbimento è dovuto al fatto che esiste una pressione negativa tra capillare e tubulo, a favore dei capillari: $$ $$ \TODO{calcolo della pressione}
- Esiste un equilibrio tra FF e riassorbimento tubulare, finalizzato al __mantenimento di una quantità coerente di acqua persa__
    - ↑ FF ⇒ ↑ proteinemia a livello dell'arteriola efferente (e quindi ↓ pressione idrostatica efferente, e ↑ pressione oncotica efferente) ⇒ ↑ frazione di riassorbimento

### Riasssorbimento nell'ansa di Henle
- __Nel tratto ascendente spesso__ vengono recuperati i __cationi ma non l'acqua__ (non sono espresse acquaporine)
...
## Meccanismi di secrezione tubulari
- __Processo che porta all'aggiunta attiva di sostanze al liquido tubulare__. Le sostanze escrete sono
    - Sostanze endogene
        - Acidi: `ac. biliari`, `ac. urico`
        - Basi: `creatinina`, `istamina`, dopamina, `adrenalina`, `acetilcolina`
...
- Trasporto a bassa specificità, tubulare massimo
- La chiave è un __antiporto anione organico/α-ketoglutarato__, che esiste sia nel fronte ematico, che nel fronte tubulare
    - `α-kg` entra __dal torrente ematico__^[Proveniente da metabolismo del `glutammato`, solitamente] mediante un __simporto Na^+^/αkg__
...
- Giornalmente il __rene deve eliminare circa
600 mOsm/die__. Il problema è __quanta H~2~O eliminare con quei soluti__ -- ovvero, in sintesi, il rene deve _decidere l'osmolarità delle urine_\
