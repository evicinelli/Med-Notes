...
-   Il nefrone è composto da 5 diverse parti
    ...
    2.  `\a{tubulo contorto prossimale}`{=tex}, che presenta cellule di
        ...
        **trasporto attivo di sostanze, per regolarizzazre attivamente
        la composizione dell'ultrafiltrato prodotto nel glomerulo**[^1]
...
-   La filtrazione è espletata da una **membrana di filtrazione** che
    ...
    **`\a{podociti}`{=tex}**, che abbracciano il capillare
    ...
    1.  L'endotelio dei capillari è *fenestrato*. Acqua e soluti passano
        sia tramite le fenestrature che tramite *pinocitosi*[^2]
...
-   `\art{arteria renale}`{=tex} \> `\art{arteria interlobale}`{=tex} \>
    ...
    **`\art{arteriola efferente}`{=tex}**[^3] \> letto di capillari
...
-   A fronte di 1L/min (600 ml/min di plasma)[^4] di flusso ematico che
    arriva al rene, il rene fisiologicamente **filtra al minuto circa il
    20% della quota di *plasma* entrante**
    ($\text{Velocità di Filtrazione Glomerulare} = VFG \simeq 125 ml/m$)[^5]
...
-   Una frazione di filtrazione del 20% produce una quantità enorme di
    ...
    **meccanismi di riassorbimento per normalizzare il volume di acqua
    in uscita**
    -   Fisiologicamente si ha un riassorbimento[^6] di 124 ml/min ⇒
...
-   Il **principale fattore che decide la VFG è la pressione dei
    ...
    della pressione arteriosa sistemica**[^7], altrimenti si avrebbero
...
-   Meccanismo automatico che le arteriole impiegano per proteggere gli
    organi a valle da un ↑ flusso ematico[^8]
...
-   Questo apparato è situato nel triangolo costruito dalla parte
    ...
    dall'`\a{arteriola efferente}`{=tex}[^9], ed è composto da 3
    elementi
...
-   Le `\a{cellule juxtaglomerulari}`{=tex} e della
    ...
    **secrezione di sostanze paracrine** in maniera da mantenere
    ...
    -   ↑ PA ⇒ ↑ VFG ⇒ ↑ \[NaCl\] nella preurina ⇒ meccanismi
        ...
        -   ↓ `renina` (cellule juxtaglomerulari)[^10]
    -   ↓ PA ⇒ ↓ VFG ⇒ ↓ \[NaCl\] nella preurina ⇒ meccanismi
        compensatori per ↑ VFG
...
-   A questo si sovrappone un controllo aggiuntivo dovuto alla
    `noradrenalina` (vasocostrizione arteriola afferente[^11])
...
-   Nella clinica le sostanze usate per misurare la VFG devono essere
    ...
    -   **Inulina** -- sostanza esogena[^14] che viene *completamente*
        escreta con le urine
    -   **Creatinina**[^15] -- sostanza endogena prodotta dal
...
-   **Per sostanze completamente escrete ⇒ FPR = CPR**
    ...
    -   In clinica routinariamente si testa la clearance della
        ...
        secreta liberamente e non viene assorbita[^17]
...
-   I meccanismi di riassorbimento tubulare sono **canali ionici** e
    **carriers** (meccanismi *selettivi* e *saturabili*[^18])
...
-   Esistono 2 meccanismi di equilibrio tra sistema del tubulo e sistema
    ...
    2.  **Bilancio glomerulo--tubulare** --- **FF $\propto$ tasso di
        ...
        -   ↑ FF[^19] ⇒ ↑ proteinemia a livello dell'arteriola efferente
            ⇒ ↓ pressione idrostatica capillare + ↑ pressione oncotica
            efferente ⇒ ↑ frazione di riassorbimento a livello dei
...
-   Nella parte luminale troviamo 2 trasportatori attivi secondari[^20]
...
-   **Aa e Pr** (trasportatori specifici)
    ...
    -   Trasportatori specifici per quelle poche proteine[^22] che sono
        ultrafiltrate (ormoni peptidici piccoli)
        -   Assorbite per endocitosi attiva (*meccanismo saturabile*, e
            in quel caso abbiamo proteinuria[^23])
...
-   Individuiamo 2 citotipi essenziali
    ...
    2.  ```{=tex}
        ...
        -   Controllo [equilibrio
            ...
            riassorbimento/secrezione di H^+^ e HCO~3~^-^)[^24]
...
-   2 classi di modulazione: ormonale e nervosa
  ...
  -----------------------------------------------------------------------
  **Riassorbimento** del  Regolatore              Sede di produzione
  Na^+^                                           
  ----------------------- ----------------------- -----------------------
  ↑ (↓ eliminazione di    Angiotensina 2          Rene
  H~2~O)                                          
                          ...
                          ADH (vasopressina)      Ipotalamo →
                                                  neuroipofisi

  ↓ (↑ eliminazione di    PNA/PNB                 Atri cardiaci
  H~2~O)                                          

                          Urodilatina             Nefrone

                          Uroguanilina e          Cellule neuroendocrine
                          Guanilina               intestinali
  -----------------------------------------------------------------------
...
-   Ha 3 funzioni
    -   **Vasocostrittore** a livello sistemico, ma preferisce
        vasocostringere l'arteriola efferente[^25] ⇒ ↑ VFG
...
-   Funzione: ↑ riassorbimento di H~2~O[^26] tramite ↑ riassorbimento di
    sodio
    ...
    -   **↑ assorbimento di Na^+^ e ↑ secrezione di K^+^** tramite \>
        ...
        -   ⇐ ↑ trasportatori ENAC[^27] nella membrana apicale
...
-   Gli anioni organici (OA^-^) vengono trasportati dal versante ematico
    ...
    nel fronte tubulare
    0.  `α-kg` entra dal versante basolaterale[^29] mediante un
        **simporto Na^+^/α-kg**[^30] nel versante basolaterale (NaDC)
...
-   La quantità di acqua da eliminare è decisa **nella parte terminale
    del nefrone[^31] dove l'assorbimento di acqua è disaccoppiato dal
...
-   I `\a{vasa recta}`{=tex} sono i capillari che si rapportano con i
    **nefroni juxtaglomerulari**.[^33] Hanno una morfologia che permette
    di non disperdere il gradiente osmotico
...
-   Il ruolo dei vasa recta è quello riassorbire l'acqua (ma anche i
    ...
    l'osmolarità dell'ambiente midollare[^34]
...
-   Il ruolo dell'`ADH` (`vasopressina`, o *ormone antidiuretico*[^35])
    ...
    -   L'entità del riassorbimento è comunque dipendente dalla
        ...
        interstizio della midollare[^36]
...
-   Baro/volocettori ⇒
    ...
    urina)
    1.  Costrizione arteriola afferente ⇒ **↓ VFG e ↑ FF**[^38] ⇒ ↓
    ...
    2.  `\goldstandard `{=tex}**renina-angiotensina-aldosterone**[^39] ⇒
...
-   **↑ LEC** ⇒ ↑ volemia circolante ⇒
    ...
    1.  Dilatazione arteriola afferente ed efferente[^40] ⇒ **↑ VFG e ↓
        FF**[^41] ⇒ ↑ escrezione di NaCl e acqua
...
-   Il ruolo del Ca^++^ è estremamente vario
    ...
    -   Coinvolto in cascate intracellulari (*onde* di calcio\_)
        -   Ormoni: quelle che coinvolgono IP~3~ e DAG[^44]
    ...
    -   `\goldstandard `{=tex}Coinvolto nel mantenimento della
        ...
        1.  Ipocalcemia ⇒ stop inibizione ⇒ ↑ facilità insorgenza PdA
            ...
            dopo un certo voltaggio, mancando il Ca^++^[^45])
...
-   I 3 ormoni si coordinano per produrre azioni su 3 distretti (anche
    ...
    -   Intestino: controllo dell'intake dietetico[^46]
...
-   Il PTH è un ormone peptidico prodotto dalle
    `\a{cellule principali}`{=tex} delle `\a{paratiroidi}`{=tex}[^47]
-   **La secrezione di paratormone è inversamente dipendente alla
    ...
    0.  Ca^++^ extracellulare si lega ad un recettore di membrana
        (caSR[^48]) sulle cellule principali della paratiroide
...
-   **Il PTH-r è espresso solo dagli osteoblasti**[^49]
    ...
    **riassorbimento del calcio**
    -   **Aumentato riassorbimento del calcio** (tubulo contorto
        ...
        -   Nel tubulo contorto prossimale abbiamo un assorbimento
            ...
            -   Sia per via paracellulare (80%)[^51]
            -   Sia per via transcellulare (20%)[^52]
    ...
    -   **Mancato riassorbimento del fosfato** (principalmente tubulo
        ...
        -   Nel tubulo contorto prossimale abbiamo la maggior parte di
            ...
            NPT~2~[^53] sull'orletto a spazzola
...
```
-   Lo ione H^+^ **si lega molto facilmente con proteine**[^54]: il pH
...
-   Alla variazione di pH contribuiscono
    ...
    -   Acidi fissi --- acidi derivanti dal metabolismo e dalla dieta
        ...
        -   Acido solforico, principalmente da aa. solforati[^56]
        -   HCl, da aa. cationici
...
-   3 sistemi principali permettono di tamponare le variazioni di pH,
    ...
    2.  **Respirazione**: azione rapida[^57]
...
-   Coppia CO~2~/HCO~3~^-^
    ...
    -   Se il rapporto \[CO~2~\]/\[HCO~3~^-^\] $\simeq$ 20[^58] **il pH
        target di questa reazione di tamponamento è 7.4**
        $$pH = (2.6 + 3.5) + \log{\frac{[HCO_3^{-}]}{[CO_2][H_2O]}} = 6.1 + \log{\frac{[HCO_3^{-}]}{[CO_2]}} \simeq 6.1 + \log{20} = 7.4$$[^59]
...
-   Il bicarbonato è un sottoprodotto del metabolismo (renale[^61])
    ...
    **concomitante azione tamponante** vera e propria delle specie che
    ...
    1.  Ammoniogenesi (+ 2HCO~3~^-^)
        -   Negli epiteliociti del **`\a{tubulo prossimale}`{=tex}**:
            ...
            -   Lo ione ammonio si mette in equilibrio[^62] con
                l'ammoniaca
...
-   Per compensare le alterazioni, a prescindere dalla causa,
  ...
  ----------------------------------------------------------------------------
  Alterazione    Variazione      pH             Azione di       Cause
                 primaria                       compenso        principali
  -------------- --------------- -------------- --------------- --------------
  Acidosi        ↑ pCO~2~        ↓              ↑ \[HCO~3~^-^\] Alterata
  respiratoria                                                  ventilazione

  Alcalosi       ↓ pCO~2~        ↑              ↓ \[HCO~3~^-^\] Alterata
  respiratoria                                                  ventilazione

  Acidosi        ↓ \[HCO~3~^-^\] ↓              ↓ pCO~2~        Squilibrio di
  metabolica                                                    acidi/basi

  Alcalosi       ↑ \[HCO~3~^-^\] ↑              ↑ pCO~2~        Squilibrio di
  metabolica                                                    acidi/basi
  ----------------------------------------------------------------------------
...
-   Meccanismi di compenso (-1.2 mmHg pCO~2~/↓ 1mEq/L di bicarbonato) si
    ...
    -   ↑ ventilazione[^63] per ridurre pCO~2~ e mantenere constante
...
-   A seconda di *quando* viene fatta l'EGA possono già trovarsi o meno
    in atto meccanismi di compenso[^64]
...
```
  ------------------------------------------------------------------------
                          Miocardio specifico    Miocardio comune (+ fibre
                                                       del Purkinje)
  -------------------- ------------------------- -------------------------
...
-   **L'instaurarsi di un potenziale di azione è dipendente anche dal
    ...
    **potassio extracellulare** si agisce anche sulle correnti
    ...
    correttamente il potenziale di azione[^66]
    ...
    -   Lisi cellulare riversano il potassio che prima era
        ...
        condizioni di progressiva ineccitabilità[^67]
...
\end{figure}
```
-   Il `\a{nodo sa}`{=tex} è il principale[^68] pacemaker naturale[^69]
    del cuore. **La sua frequenza intrinseca è di 60-100 bpm**
...
-   La depolarizzazione spontanea tipica del complesso pacemaker è il
    ...
    3.  **Una corrente depolarizzante (in entrata) del Ca^++^**
        ...
        -   La fase 0 è dovuta primariamente a canali Ca^++^ LL[^70]

### Nodo AV

-   È **l'unico punto che consente il passaggio dell'impulso di
    contrazione dagli atri ai ventricoli**[^71]
...
-   Costituisce un **avviatore secondario** del battito, siccome ha una
    ...
    -   In caso di una eccessiva frequenza di genesi del nodo SA *non
        accompagnata da una congruente regolazione ortosimpatica*[^72]
...
-   Possono fungere da avviatori terziari (20--40 bpm)[^73]
...
-   Il ciclo cardiaco è composto dall'alternarsi di **sistole** e
    **diastole** (\~ 0.8 s). La sistole atriale è concomitante con la
    ...
    -   Sistole (mediamente 0.3 secondi, ↓ al bisogno ma sempre ≥ 0.2
        ...
        2.  Sistole isovolumetrica[^76]
        3.  Sistole auxotonica[^77]
...
5.  **Diastole** (*fase di riempimento*) --- continua ↓ tensione,
    ...
    -   Seconda fase (lenta) di riempimento, che conta per la maggior
        ...
        la fase più sacrificata quando aumenta la FC[^78]
...
-   Fase 3 termina con un repentino crollo della pressione ventricolare
    ...
    elastico delle pareti[^79] ⇒ chiusura della valvola aortica (\~ 100
    mmHg)
...
-   Rumori anomali
    ...
    -   *Soffi cardiaci*: indice di turbolenze e di passaggio del sangue
        ...
        -   Anomalie nella chiusura (insufficienza valvolare[^81])
...
-   Il lavoro *statico* del **ventricolo destro** ammonta a \~ **0.14
    ...
    -   $V$ = 70 ml
-   Il lavoro *totale* (= statico + dinamico[^82]) è
    ...
    **postcarico**
    -   **Precarico** (quanto sangue il ventricolo deve pompare, "quanto
        ...
        -   È di fatto una misura *indiretta* del **ritorno venoso** (+
            volume telediastolico)[^83], anche se formalmente il
...
-   La gittata cardiaca viene regolata secondo varie modalità in maniera
    ...
    2.  Mantenere *sostanzialmente*[^85] equivalenti la gittata dx e sx,
        per evitare stasi o accumuli nel grande o nel piccolo circolo
...
-   Così come il muscolo scheletrico sviluppa una tensione proporzionale
    alla sua lunghezza di partenza[^86], **anche il muscolo cardiaco è
...
-   Il grado di distensione della parete miocardica è direttamente
    ...
    -   Obiettivo: mantenere un corretto bilanciamento tra flusso in
        ...
        qualsiasi motivo il ventricolo si riempie più del normale*[^87]
...
-   L'intervento di una branca del simpatico è potenziato anche dal
    fatto che **perifericamente** (*e non solo* centralmente[^90]) si
...
-   **Il flusso coronarico tende ad autoregolarsi per essere il più
    ...
    -   ↑ pressione aortica ⇒ ↑ resistenza coronarica
        (vasocostrizione[^92]) per conservare il flusso a valle
    -   ↓ pressione aortica ⇒ ↓ resistenza coronarica
        (vasodilatazione[^93]) per conservare il flusso a valle
...
-   **Arterie**: convertono il flusso cardiaco discontinuo in flusso
    ...
    -   Permettono di convertire un flusso discontinuo in continuo, per
        ...
        -   ↓ il lavoro cardiaco (perché evita al cuore di dover vincere
            ...
            compliante)
        -   Sfruttano l'[**effetto
            Windkessel**](https://it.wikipedia.org/wiki/Effetto_Windkessel)[^95]
...
2.  **Fattori fisiologici**: influenzano principalmente la *pressione
    media*
    -   Resistenza periferica[^96] (delle arteriole)
    -   Gittata cardiaca
...
-   ↑/↓ compliance arteriosa
    ...
    -   Nessun effetto sulla pressione media[^97]
    -   ↓/↑ pressione differenziale
...
-   La regolazione della PA avviene modificando 4 parametri
    ...
    -   Capacità vasale venosa (vasomozione venosa[^98])
    ...
    -   Volocettori atriali
        1.  **Volocettori atriali di tipo A** --- volocettori atriali
            ...
            -   Danno luogo al **riflesso di Bainbridge** (↑ PA atrio dx
                ...
                specifiche dirette al nodo SA\])[^100]
...
-   Le efferenze simpatiche/parasimpatiche producono[^102] 2 ordini di
...
-   La parete è costituita da una grande parte di **muscolatura
    liscia**[^103] e **componente elastica** (decisamente meno che nelle
    ...
    -   In condizioni fisiologiche la muscolatura liscia è sempre
        contratta[^105] (*tono basale del centro pressorio ortosimpatico
        sempre attivo!*)
...
-   Regolazione locale del diametro dell'arteriola operate da
    **secrezioni endoteliali** dell'arteriola stessa:
    1.  `\goldstandard `{=tex}**Monossido d'azoto** (`NO`)
        ...
        -   *Diffusione*[^106]del NO a recettori *intracellulari* dei
...
-   Operato da SNA (principalmente *ortosimpatico*) con catecolammine
    ...
    del distretto e del recettore[^107]
...
-   Originano dalle arteriole/meta-arteriole[^108]
...
-   Le vene sono strutture molto distensibili e complianti
    ...
    -   Essendo *estremamente* distensibili, risentono molto della
        ...
        dal piano neutro cardiaco = ± 0,77 mmHg di pressione[^109]) ⇒ in
        ...
        -   ↑ PVC[^110] ⇒ *turgore vene superficiali* (e/o profonde) del
            collo
...
3.  Resistenze periferiche (1/$\propto$)
    ...
    -   La modulazione delle resistenze (*tono arteriolare e venulare*)
        cambia la pendenza della curva vascolare.[^112] Questo ha un
...
-   **In condizioni basali il ritorno venoso deve essere uguale alla
    gittata cardiaca**, per evitare stasi e accumuli patologici[^113]
...
\end{figure}
```
-   In caso di improvviso aumento della sola pressione venosa[^114] il
    ...
    0.  ↑ PVC repentinamente (*punto A*): il ritorno venoso non è più
        ...
        compenso
    1.  ↑ PVC ⇒ ↑ ritorno ⇒ ↑ volume telediastolico ⇒[^115] ↑ gittata
        (*punto B*)
...
-   La funzione del SNA consiste in una integrazione due modalità: **per
    ...
    -   **`\underline{Comandi}`{=tex} nervosi autonomici** --- circuiti
        nervosi complessi[^117] che coinvolgono l'encefalo che adattano
...
-   **Il neurotrasmettitore dei neuroni pregangliari** (orto E
    ...
    1.  **Recettori nicotinici** per l'ACh
        ...
        -   Sottotipo N~2~, differente dall'analogo recettore del
            ...
            -   N~2~ sono bloccati da `esametonio`[^122]
...
-   Utilizzano **`noradrenalina`** come neurotrasmettitore principale,
    **aggiunta ad altri neurotrasmettitori** o neuropeptidi secondari
    -   I cotrasmettitori secondari[^124] hanno un effetto più lento, ma
        più duraturo
...
-   I neurotrasmettitori si legano prevalentemente[^127] ai recettori
    **muscarinici** (*metabotropi*),
    ...
    2.  **M2**: ↓ cAMP
        -   Regolano specificamente l'attività del pacemaker cardiaco in
            senso bradicardico[^128]
    3.  **M3**: ↑ DAG e IP3 ⇒ [Ca^++^](#ca) citosolica
        -   ↑ sintesi NO endoteliale[^129] ⇒ vasodilataione (sopratutto
...
-   *Non influenza la qualità della ventilazione* (frequenza e
    ...
    centri nervosi ipotalamici, coinvolti in circuiti del SNA[^132])
...
-   Midriasi[^133] ⇒ migliorare acuità visiva da lontano + permettere
...
-   Presente innervazione parasimpatica solo in 2 distretti
    ...
    -   Distretto genitale: **vasodilatazione** M3-mediata[^134]. Notare
...
-   La ratio è **rest and digest**
    -   **Fegato**: ↓ gluconeogenesi e ↑ glicogenosintesi[^135] (⇐
        stimolazione vagale)
...
1.  Vescica **in riempimento** ⇒ distensione della parete ⇒ stiramento
    ...
    somatica, in parte)
    -   `\att `{=tex}`\textcolor{Maroon}{\textsc{ortosimpatico}}`{=tex}[^136]
        ⇒ ↓ tono vescicale
    ...
    -   Parte somatica (`\ner{nucleo di onuf}`{=tex}[^137]) ⇒ ↑ tono
...
2.  ↑ pressione sui meccanocettori della parete vescicale + segnale
    ...
    1.  Fase iniziale, mediata dal
        ...
        -   `\ini `{=tex}`\textcolor{Maroon}{\textsc{ortosimpatico}}`{=tex}
            E
            `\att `{=tex}`\textcolor{ForestGreen}{\textsc{parasimpatico}}`{=tex}[^138]⇒
...
-   Brivido: contrazione muscolare non coordinata e involontaria ad alta
    ...
    -   Mantenuto da motoneuroni α sotto il controllo dei centri
        superiori[^141] che controllano la termogenesi
...
-   Protagonisti: **ormoni tiroidei** (T3 e T4) ⇒ sintesi di ormoni
    *disaccoppianti*
    -   ↑ espressione di `UCP` sopratutto in `\a{bat}`{=tex}[^142] e nel
        muscolo striato
...
-   Via costituita da neuroni di 3 ordini
    ...
    1.  I neuroni di primo ordine raccolgono le informazioni dai
        meccanocettori cutanei periferici[^146]; le fibre nervose
...
-   `\marginnote{\neuronetter{35}}`{=tex} Le aree somatosensitive della
    ...
    `\a{circonvoluzione post-centrale}`{=tex}[^148]
...
-   Sensazione dolorosa che nasce non dall'attivazione dei nocicettori,
    ...
    una stimolazione non nocicettiva[^149] che porta a soglia i neuroni
...
-   A seconda della lesione che attiva il circuito nervoso si distingue
    ...
    2.  **Dolore neuropatico centrale**: dolore molto intenso, continuo
        ...
        lesioni[^150] *centrali* a carico del `\ner{vpl}`{=tex}
...
-   I recettori periferici aumentano la frequenza di scarica per vari
    ...
    -   Depolarizzazione massiva di *molteplici* terminazioni
        nocicettive, con permanenza in situ del neurotrasmettitore[^152]
...
-   Fenomeno per cui in determinante circostanze (*fight or fly*[^153])
...
-   L'inibizione periferica del dolore si può raggiungere mediante la
    ...
    (*"oppioidi"[^154] endogeni* :`endorfine`, `encefaline`,
...
-   Normalmente il circuito di anti-nocicettivo è tenuto inibito da
    ...
    -   Mediante stimolazione degli interneuroni inibitori
        *encefalinergici*[^155] del sistema anterolaterale con oppioidi
...
-   Ci sono 4 categorie di movimenti (volontarietà e complessità
    ...
    2.  **Movimenti ritmici** --- schemi motori coordinati,
        ...
        stimoli integrati nel `\a{tronco encefalico}`{=tex}[^156]
...
-   **Via finale comune** ≡ a prescindere da quali informazioni
    contribuiscano[^160], mediante integrazione, a determinare il
...
-   Distinguiamo 2 vie discendenti che controllano il movimento, a
    ...
    -   **Vie del sistema dorso-laterale**: governano i motoneuroni e
        ...
        sinistro sono decisamente separati[^161], sia funzionalmente che
        morfologicamente
        1.  Via dal `\ner{nucleo rosso}`{=tex}
...
-   La continuità "verticale" dei 2 circuiti, tra i vari segmenti della
  ...
  I sistemi dx e sx sono              Piuttosto         Uniti e
                                      separati          coordinati

  Neuroni propriospinali              Corti             Lunghi[^162]

  Interneuroni                        Stretamente       Anche
...
3.  Mediante fibre efferenti che *risalgono*, influenza l'azione dei
    ...
    coordinazione e la precisione del movimento[^166]
...
-   Circuito generale: corteccia → nuclei della base → talamo →
    ...
    -   **Efferenze** --- proiettano tramite il talamo + direttamente
        -   Proiettano tramite il talamo[^167] a 4 regioni della
...
2.  Vie aeree inferiori
    ...
    -   Vie aeree di conduzione (bronchi \> bronchioli)
        ...
        -   Costituite dalle prime 16 generazioni di ramificazioni dei
            bronchi lobari ("*spazio morto respiratorio*"[^170] di 150
            ml)
            -   Bronchi di conduzione (generazioni 2[^171]--9)
...
-   Lo strato cellulare che compone gli alveoli è composto da 3 tipi di
    ...
    2.  Pneumociti di 2/o tipo --- sintetizzano
        `tensioattivo polmonare`[^172] (piccole e cuboidali)
...
-   La circolazione bronchiale è \~ 70 ml, ma può variare a seconda
    ...
    -   Può aumentare (mediante il **reclutamento di nuovi capillari**)
        durante esercizio fisico (max 200 ml)[^174]
...
## Ventilazione
  ...
  ----------------------------------- -----------------------------------
  Volume per atto respiratorio        \~ 500 ml (6--8 ml/kg)
  (volume corrente - VC)              
...
![](data:image/png;base64,)
...
```
  -------------------------------------------------------------------------
                          Ormone                  Bersaglio o azione
  ----------------------- ----------------------- -------------------------
  GH                      Growth Hormone          ↑ metabolismo, crescita
                                                  corporea

  PRL                     Prolattina              ↑ ghiandola mammaria,
                                                  lattazione

  TSH                     Tireotropo              `\att `{=tex}secrezione
                                                  ormoni tiroidei

  ACTH                    Corticotropo            `\att `{=tex}secrezione
                                                  ormoni corticali
                                                  surrenali
...
-   La secrezione è stimolata e regolata secondo 3 modalità
  ...
  ---------------------------- ------------------------------------------
  GPL1 (Glucagon-Like Peptide  Adrenalina
  1)                           
...
-   Tramite spirometria, sopratutto dinamica, si diagnosticano
  ...
  Restrittiva   ↓               ↓     Ok o ↑ (per riduzione del
                                      parenchima)
  ------------------------------------------------------------------------
...
[^1]: Presentano trasportatori attivi sia sul lato basolaterale (a
    contatto con i vasi) sia sul lato luminare

[^2]: Trasporto dal lume del vaso all'esterno del vaso mediante
    vescicole che attraversano l'endoteliocita

[^3]: Unico caso di tutto il corpo in cui si ha una situazione del tipo
    arteriola → rete capillare → **arteriola**. Questo permette di
...
[^4]: FPR, Flusso Plasmatico Renale

[^5]: Di fatto, appunto, 125 ml/min è il 20% del 60% (perché il plasma
...
[^6]: Tubulo contorto + ansa di Henle

[^7]: La PA varia molto durante il giorno, non per forza secondo uno
    schema patologico: la variazione è consistente anche solamente se da
    sdraiati ci portiamo in piedi

[^8]: ↑ flusso ematico è problematico da gestire per gli organi -- se
    questi non sono in grado di accomodarlo

[^9]: Riferirsi all'anatomia del glomerulo

[^10]: La renina è un enzima ad azione sistemica che
...
[^11]: Quando scappo dal leone non devo fare la pipì...

[^12]: E quindi, di fatto, è la misura di quanta di quella sostanza
    ritroverò nel volume di urina prodotto in un minuto

[^13]: Principio base: **massa in entrata nel rene = massa in uscita dal
    rene**

[^14]: Polimero del fruttosio a basso PM ⇒ filtrazione libera (scenario
    1)

[^15]: In realtà un 10% viene eliminato in altri modi, tuttavia la
    misura della creatinemia la sovrastima del 10%

[^16]: Essenzialmente: quanto di una data sostanza ho nelle arterie o va
    nelle urine come filtrato o prosegue nelle vene a valle del
    glomerulo

[^17]: Quindi è una stima attendibile per misurare la funzionalità
    renale

[^18]: Si ha saturazione quando il carico tubulare è in eccesso rispetto
    alla disponibilità del trasportatore (perché il trasportatore ha una
    velocità massima, raggiunta ad una determinata concentrazione del
    soluto da trasportare). La concentrazione a cui questo succede
    dipende direttamente dal numero di trasportatori selettivi per
    quella sostanza

[^19]: $FF = \frac{VFG}{FPR}$, per cui una sua variazione può derivare
    da variazioni sia della VGF che della FPR

[^20]: Sfruttano il gradiente di Na^+^ per `\emph{co}`{=tex}trasportare
...
[^21]: Probabilmente per via della solvatazione degli ioni?

[^22]: Anche se le proteine filtrate al minuto sono poche, visto che
    l'ultrafiltrato è 180 L/giorno la quota proteica che viene
    riassorbita è comunque notevole (7.2g/giorno)

[^23]: Clinicamente associata a danno renale, perché la causa di una
    proteinuria spesso è un danneggiamento del sistema di filtrazione
    glomerulare, che diventa molto più permissivo

[^24]: Le cellule intercalate esprimono trasportatori sia per gli ioni
...
[^28]: Non tratto sottile ansa di Henle

[^29]: Proveniente da metabolismo del `glutammato`, solitamente

[^30]: Na^+^ dentro, α-kg dentro

[^31]: `\a{tubulo distale}`{=tex} e nel `\a{dotto collettore}`{=tex}

[^32]: Essenzialmente, avere un ambiente iperosmotico è necessario
...
[^33]: Nefroni giustapposti all'inizio della zona midollare con anse di
    Henle luuuuuuuuuuuunghe lunghe

[^34]: Osmolarità che sarebbe ridotta senza i vasa recta per la
...
[^35]: In inglese: anche AVP (Arginine VasoPressin)

[^36]: Differenza osmotica prodotta dall'ansa di Henle mediante i
...
[^37]: Il significato fisiologico di avere un set point leggermente
...
[^38]: Abbiamo un ↑ della FF perché, in situazioni di ipovolemia, il
...
[^39]: angiotensinogeno $\xrightarrow{renina}$ angiotensina 1
    $\xrightarrow{ACE}$ angiotensina 2

[^40]: Per `\ini `{=tex}ortosimpatico

[^41]: Abbiamo un ↓ FF perché, in situazioni di ipervolemia, il rene
...
[^42]: Ipkaliemia ⇒ ipokaliemia ⇒ iperpolarizza la membrana e la
...
[^43]: Iperkaliemia ⇒ iperdepolarizza la membrana la cellula. Grosse
...
[^44]: Diacilglicerolo e inositolo 3-fosfato

[^45]: Sintomo di ipocalcemia: tetania muscolare secondaria a
...
[^46]: Giornalmente, su 1g assunto se ne assorbono 150 mg

[^47]: 4, 2 per ogni lobo della `\a{tiroide}`{=tex}

[^48]: Ca Sensitive Receptor

[^49]: Osteoblasti: cellule attivamente produttive; osteoclasti:
...
[^50]: Osteo`\emph{b}`{=tex}lasto produce prima M-CSF (che recluta dalla
    linea monocito-macrofagica il pre--osteoclasto e permette l'inizio
    del differenziamento); successivamente produce `RANK-l`, che si lega
    al `RANK-r` dei preosteoclasti, i quali completano l maturazione in
    osteo`\emph{c}`{=tex}lasti. In aggiunta, legandosi sul `RANK-r` degl
    osteoclasti maturi, promuove la produzione di enzimi digestivi e
    delle pompe che gli osteoclasti usano per acidificare l'ambiente
    sotto di loro\
    ![](img/stimolazione-osteoblasti-osteoclasti-pth.png){width="6cm"}

[^51]: Mediante il meccanismo del **drenaggio del solvente** --
    meccanismo che avviene specialmente a livello del tubulo prossimale

[^52]: Mediante trasportatori attivi, meccanismo principe a livello del
    tubulo distale

[^53]: Simporto 3Na^+^ in/1P~i~ in

[^54]: Le proteine hanno una parziale carica negativa dovuta al fatto
    che la gran parte degli aa è lievemente carico negativamente

[^55]: $CO_2 + H_2O \leftrightarrow H_2CO_3 \leftrightarrow H^{+} + HCO_3^{-}$

[^56]: Va notato che di base noi assumiamo con la dieta un eccesso di
...
[^57]: Il controllo della frequenza respiratoria mediante i centri
...
[^58]: Il rapporto è mantenuto fisiologicamente su questo livello, per
...
[^59]: Questo mi dice anche che per concentrazioni uguali di CO2 e
    bicarbonato, il tampone ha un pH target di 6.1

[^60]: CO~2~ + H~2~O $\xrightarrow{\texttt{anidrasi carbonica}}$ H^+^ +
    HCO~3~^-^

[^61]: *La glutammina viene metabolizzata in 2 sedi*: fegato e rene

[^62]: NH~4~^+^ $\leftrightarrows$ NH~3~ + H^+^

[^63]: ↑ pH ⇒ chemocettori stimolano centri della ventilazione

[^64]: Es: se ↑ pCO~2~ dopo poco entra in gioco il meccanismo di
    compenso metabolico e troveremo ↑ bicarbonato

[^65]: La quale normalmente, agganciata alla `tropomiosina` copre i siti
    di legame nei filamenti di `actina`. Il legame con il calcio sposta
    la troponina (e quindi anche la tropomiosina) liberando i siti di
    legame dell'actina. La miosina allora potrà legarsi (con un legame
    definito *ponte trasverso*) e spostarsi, permettendo lo scivolamento
    dei filamenti di miosina tra quelli di actina, determinando
    l'accorciamento del sarcomero ⇒ contrazione del miocita

[^66]: Si può addirittura arrivare a impedire l'instaurarsi del
...
[^67]: Vedi, ad esempio, `\pat{danno da riperfusione}`{=tex}

[^68]: Sono stati rilevati *siti satelliti* dotati di automaticità al
    pari del nodo seno--atriale

[^69]: Ovvero il gruppo di cellule che genera spontaneamente un PdA, il
    quale induce poi la contrazione di tutti gli altri cardiomiociti

[^70]: Ci aspettiamo quindi che antagonisti dei canali LL per il calcio
    ↓ ampiezza e velocità di genesi del PdA

[^71]: Collocato nel setto interatriale, in prossimità dei ventricoli

[^72]: Come, ad esempio, in caso di `\pat{fibrillazione atriale}`{=tex},
    che determina una contrazione maggiormente scoordinata (comunque
    efficace ma non efficiente)

[^73]: Le cellule del P. hanno una risposta *rapida* al potenziale:
...
[^74]: Ma la risposta è alterabile tramite l'uso della tetradotossina

[^75]: Questo vuol dire che in ogni momento si ha sia una innervazione
...
[^76]: Equivalente tridimensionale del concetto di contrazione
    isometrica

[^77]: Auxotonico = isometrico + isotonico. In una prima fase si ha una
...
[^78]: Non a caso, una tachicardia importante ↓ la perfusione ⇐ ↓
    gittata ⇐ volume eiettato ⇐ ↓ durata della diastole

[^79]: L'aorta e i grandi vasi si gonfiano, per via della pressione
...
[^80]: La chiusura della mitrale precede quella della tricuspide. Se il
...
[^81]: Ribaltamento della valvola, che non chiude bene e lascia uno
    spiraglio

[^82]: $K = \frac{1}{2}mv^2$

[^83]: **↑ precarico ⇔ ↑ ritorno venoso**. Volendo essere precisi non
...
[^84]: Volendo essere precisi quantifica la tensione che la parete
...
[^85]: Naturalmente questo non deve essere vero per *ogni* battito, ma
...
[^86]: Questo è un principio tipico del muscolo striato: l'allungamento
...
[^87]: In altre parole, questo non vuol dire che il ventricolo si
...
[^88]: Anche se è valido anche per il ventricolo sx naturalmente

[^89]: Il plateau, PdA a risposta rapida (quello dei cardiomiociti
    contrattili) è mantenuto dalla corrente di Ca^++^

[^90]: Normalmente quello che succede è che tendenzialmente il tono
...
[^91]: Ma questo è sensato: il glucagone è un ormone iperglicemizzante,
...
[^92]: ↑ PA ⇒ distensione del vaso ⇒ contrazione reattiva del muscolo
    liscio ⇒ vasocostrizione

[^93]: ↓ PA ⇒ ↓ distensione del vaso coronarico ⇒ rilassamento del
    muscolo liscio ⇒ vasodilatazione

[^94]: \[cAMP\] è correlato direttamente con la frequenza di apertura
    dei **canali I~f~** (funny) **per il Na^+^** responsabili di
    generare la DdP che permette il firing delle cellule pacemaker

[^95]: La compliance della parete vasale, in fase di sistole permette
...
[^96]: Perché naturalmente, ↑ resistenza periferica ⇒ accumulo di sangue
    a monte. Infatti: $Flusso=\frac{Pressione}{Resistenza}$

[^97]: La ragione per cui non c'è effetto nella pressione media è perché
    la compliance non altera il volume medio di sangue che transita
    nelle arterie, poiché l'effetto di compliance è simmetrico sia in
    fase sistolica che in fase diastolica, e pertanto l'effetto medio si
    compensa. Viceversa, un aumento di compliance abbassa la pressione
    differenziale, poiché `\emph{diminuisce}`{=tex} la
...
[^98]: Venocostrizione → ↑ precarico → ↑ gittata cardiaca (per
    Frank--Starling) ⇒ ↑ PA

[^99]: Perché frequenze più alte comporterebbero un intervallo tra i
    picchi più ridotto del periodo di refrattarietà assoluta

[^100]: Un esempio classico è quello delle **aritmie sinusali
...
[^101]: Aumento che, tra l'altro è chiaramente osservabile in casi di
    denervazione parasimpatica (fino a 200 mmHg!)

[^102]: Tecnicamente ortosimpatico e parasimpatico innervano due
    segmenti differenti: il nodo SA viene innervato da entrambe le
    branche, mentre il nodo AV solo dalla branca ortosimpatica

[^103]: Organizzata a formare un sincizio funzionale mediante *gap
    junction*

[^104]: Permette, a titolo di esempio, di passare da una gittata di 5
...
[^105]: Tanto che se la pressione arteriolare cala sotto una certa
...
[^106]: Gassoso ⇒ emivita bassa e ottima permeabilità nella membrana
    cellulare

[^107]: Ricordiamoci che l'azione principale dell'adrenalina è
    ridistribuire il flusso agli organi dove serve

[^108]: Arteriole che presentano meno muscolatura liscia, e possono
    anche bypassare reti capillari formando shunt arterovenosi

[^109]: $-0.77h$ se consideriamo il segmento cuore--testa (F~peso~
...
[^110]: Pressione Venosa Centrale, ovvero la pressione venosa misurata
    nella vena cava superiore/atrio dx

[^111]: Naturalmente la pressione non è nulla perché 5 litri di sangue
...
[^112]: Per essere precisi una vasocostrizione produce un calo maggiore
...
[^113]: Producendo edema polmonare e ipoperfusione tissutale e tutto
    quello che sta in mezzo a 'ste due robe

[^114]: Sperimentalmente questo è ottenibile tramite una trasfusione di
...
[^115]: ⇐ meccanismo di Frank Starling

[^116]: *Es: omeostasi pressoria (controllo dell'attività cardiaca e
    controllo vasomotorio)*

[^117]: Il principale centro integrativo risulta essere
...
[^118]: *Es: nel momento in cui un atleta è sui blocchi di partenza,
...
[^119]: Ovvero: per prevalere l'effetto parasimpatico si avrà una
...
[^120]: Il significato fisiologico è quello di "svincolare" le attività
...
[^121]: Operativamente il movimento ritmico della peristalsi è
    normalmente portato avanti da `\a{cellule del Purkinje}`{=tex}

[^122]: L'`\far{esametonio}`{=tex} è un farmaco **ganglioplegico**, che
...
[^123]: Come se la prima scarica "pre-eccitasse" il neurone, permettendo
    lala scarica muscarinica di essere maggiormente efficace

[^124]: Somatostatina, Neuropeptide Y, ATP...

[^125]: Adrenalina e noradrenalina sono prodotte dalle
...
[^126]: Il cortisolo induce l'iperproduzione dell'enzima
    `N-metil-transferasi`, enzima chiave nella biosintesi
    catecolaminergica

[^127]: Altri neurotrasmettitori, diversi dall'ACh, si legheranno ai
    propri recettori

[^128]: Sono recettori di membrana legate a proteina G. Successivamente
    al legame, la sub. βγ provoca l'apertura dei canali K^+^, che esce ⇒
    iperpolarizzazione delle cellule ⇒ ↓ insorgenza PdA

[^129]: Con il meccanismo già visto nella dispensa di biochimica:
...
[^130]: Non chiaramente dimostrato nell'uomo come possano regolare
    l'attività vascolare a livello muscolare

[^131]: Ci sta, se scappo dal leone ho bisogno di tanta aria, quindi
    bronchi ampli

[^132]: È quindi parzialmente autonoma: ipossia marcata stimola un
    riflesso inspiratorio/ipercapnia ⇒ ↑ FR

[^133]: Funzionalmente è necessario che, se arriva il leone che mi
...
[^134]: Sono state individuate anche fibre nitrergiche + sistemi
    intrinseci (con fibre glutamminergiche e colinergiche)

[^135]: Questo rimane ultimamente dipendente dallo stato di assunzione
    nutrizionale

[^136]: Dal tratto toracolombare → `\nerorto{n. ipogastrico}`{=tex} →
    parete e sfintere vescicale

[^137]: Corna anteriori tra S~2~ ed S~4~

[^138]: Tramite `\nerpara{nn. pelvici}`{=tex} e gangli del
    `\nerpara{plesso pelvico}`{=tex}

[^139]: Ovvero la differenza tra energia in ingresso e in uscita

[^140]: Ricerche in sviluppo sembrano suggerire che questo non sia il
    caso, ma che ci siano semplicemente delle *soglie* sotto o sopra le
    quali si innescano meccanismi di termogenesi o termolisi

[^141]: Particolarmente centri `\a{rvmm}`{=tex} della parte mediale del
    `\a{bulbo}`{=tex}

[^142]: BAT è particolarmente presente in neonati, bambini piccoli e
...
[^143]: Filtrato primario a composizione analoga a quella del plasma ⇒
    **riassorbimento** guidato dal gradiente di Na^+^ e Cl^-^
    (disperdere *troppo* NaCl con il sudore sarebbe problematico)

[^144]: In situazione di esercizio fisico in ambiente caldo si
...
[^145]: **Organizzazione somatotropica** --- organizzazione di 2
...
[^146]: Corpuscoli di Meissner e di Pacini, terminazioni di Ruffini,
    cellule di Merkel, fusi neuromuscolari, organelli muscolotendinei di
    Golgi

[^147]: Volendo essere pedanti, in realtà il nucleo è il VPI, non
    proprio il VPL

[^148]: Subito posteriore alla corteccia motoria primaria (situata nel
    `\a{giro prefrontale}`{=tex})

[^149]: Esempio banale: erniazione del disco, o sciatalgia: se ho una
...
[^150]: Tumorali, traumatiche, infettive, iatrogene, post-infartuali...

[^151]: In sostanza: mi ustiono, ok, poi mi tocco delicatamente la zona
...
[^152]: Semplicemente perché se n'è liberato un botto e lì rimane

[^153]: Obiettivo: non farti paralizzare dal male quando il leone ti ha
    morso una gamba, ma usare la gamba maciullata per correre veloce e
    lontano

[^154]: Nel senso che sono sostanze che ricordano morfologicamente le
    molecole oppioidi, non che noi siamo dei papaveri e produciamo
    realmente oppioidi endogeni

[^155]: Neuroni che usano `encefalina` come principale neurorasmettitore

[^156]: Studi in animali nel quale è stato sconnesso il centro dalla
...
[^157]: Un esempio tipico è la reazione fight or fly: si organizza un
...
[^158]: Movimenti per linguaggio, movimento di arti e mani...

[^159]: I principali interneuroni inibitori sono 2: (1)
...
[^160]: Sensoriale periferica, controlli riflessi, ripetitivi, istintivi
    o raffinati (corticali)

[^161]: Questo ha come significato funzionale quello di garantire
...
[^162]: Questo significa che porizoni lontane del midollo sono
...
[^163]: Cosa che ha senso: mantengo la postura eretta senza ragionarci
    sopra più di tanto

[^164]: N.B: la componente flessoria evoluzionisticamente è venuta
...
[^165]: I compiti sono stati studiati valutando le alterazioni
    conseguenti ad ablazioni del cervelletto

[^166]: N.B: il cervelletto non migliora il movimento influenzando
...
[^167]: Nucleo medio--dorsale, nucleo ventrale anteriore (VA), nucleo
...
[^168]: È una denominazione che indica tutti quei sistemi motori *non
...
[^169]: L'area premotoria ha funzione di area associativa unimodale,
    dando un contributo essenziale nel *progettare* il movimento prima
    di eseguirlo effettivamente

[^170]: Volume non adibito allo scambio

[^171]: 0 è trachea, 1 sono i bronchi dx e sx

[^172]: Necessario perché gli alveoli sono talmente piccoli che, se non
...
[^173]: Infatti SpO~2~ normale è \~ 99%, non 100%

[^174]: Ecco perché si dice che bisogna "rompere il fiato", o perché chi
