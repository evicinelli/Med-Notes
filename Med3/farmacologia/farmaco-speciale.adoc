...
* Psichiatrici → agitazione, confusione, allucinaizoni, manie, disforia
* Autonomici → ipertensione, tachicardia, sudorazione, ipertermia, brividi
* Somatici → mioclono, iperriflessia
...
=== Lipopetidi
* `daptomicina`
* MdA: *porazione della parete cellulare*, provocando la morte del batterio _senza lisi_ (per porazione: necessari ioni Ca^{pp}^)
* Spettro di azione: molto ampio
* *Concentrazione-dipendente* (somministrazione *in bolo in 2-3min*)
* Inattivata dal surfactante polmonare (ha coda lipidica, surfactante agisce da sapone...) ⇒ non efficace in polmoniti

.Farmacocinetica
* (D) 92% legata con carrier, T~1/2~ 7--9h
* (E) renale

.Indicazioni terapeutiche
* Infezioni Gram^pos^ MDR, anche in co-somministrazione
	* Batteriemie, endocarditi
...
* Cinetica estremamente particolare: *tempo-dipendente con caratteristiche di concentrazione-dipendenza*
	** Azione *long-acting*: (si può fare *dose unica* (1,2/1,5g) e questa ha un effetto post-abx molto prolungato)
	** Emivite lunghissime: 250--300h

.Indicazioni terapeutiche
* Unica approvata: aBSSI
...
* TDM per eeaa non proprio simpatici
...
.Effetti collaterali
* Trombocitopenia dose-dipendente
* Anemia
* Si comporta da IMAO ⇒ ↑↑ RR sdr serotoninergica quando co-tp. con antidepressivi
* Neuropatie periferiche
* Acidosi lattica (come metfomrina)

.Indicazioni
* Gram^pos^ aerobi e anaerobi resistenti (MRSA, VRSA)
	** Polmoniti, infezioni di cute e tessuti molli, meningiti, osteomieliti, colangiti
