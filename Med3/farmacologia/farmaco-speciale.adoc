...
* Più linee di intervento
	...
	** ^131^I --- MdA: distruzione dei tireociti (_molto specifica e rapida_) per captazione di iodio radioattivo in tiroide. Assolutamente nada in gravida/allattamento
...
* Osteonecrosi della mandibola (improbabile a dosi comuni, correlato ad alte dosi, > R in tp. +1aa e procedure dentali invasive)
