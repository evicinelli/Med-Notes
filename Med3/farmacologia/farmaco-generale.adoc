...
++++
3. *Dose di carico*: si somministra così quando (tipicamente in urg) è necessario raggiungere immediatamente una concentrazione plasmatica che è terapeutica, per poi mantenerla
+
[latexmath]
++++
\begin{align}
