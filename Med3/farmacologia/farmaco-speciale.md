...
###### Effetti ritardati in tp. lunghe (+RR)
...
###### Farmacocinetica
- (A) F~OS~ > 0.95!
- (D) emivita *molto* lunga (~ 100h); > 90% legate a carriers
- (M) Epatico (CYP2C9)
...
- B~12~ viene assorbita PO sse coniugata con il *fattore intrinseco*, proteina prodotta da cellule parietali dello stomaco
...
|					   | Fabbisogno		   	  |					      |
+======================+======================+=======================+
| Gravidanza		   | 0.4---0.6 mg		  | Valori < sono		  |
|					   |					  | correlati			  |
|					   |					  | positivamente con	  |
|					   |					  | difetti della		  |
|					   |					  | chiusura del tubo	  |
...
## Eritropoietina
- Analoghi esogeni dell'EPO che stimolano direttamente l'eritropoiesi
- ⚠ Eritropoietina è farmaco dopante ⇒ **ricetta limitativa** (solo specialisti per specifiche condizioni cliniche)
...
- Occorre distinguere l'approccio locale da quello generale
	...
	- **Anestesia generale** (AG) --- è procedura complessa, che comprende all'interno 5 obiettivi (tutti ugualmente importanti)
		- Incoscienza (*ipnotici*)
		- Amnesia anterograda (*ipnotici*)
		- Inibizione dei riflessi sensoriali e vegetativi (*ipnotici*)
		- Analgesia (*analgesici*)
		- Miorilassamento (*miorilassanti*)
...
| Stadio (profondità) | Anestesia | Scenario |
|-|---|---|
| 1	| Molto lieve	| Ch ambulatoriale leggera |
| 2	| Dissociativo	| Tendenzialmente non desiderabile (🐲) |
| 3	| Profonda (RS)	| Sedazione procedurale |
| 4	| Completa (con apnea)	| AG |

: Piani di profondità della sedazione indotta

## Benzodiazepine
- Vedi [Benzodiazepine](#bdz)
...
- ⚠ Induce depressione respiratoria (spp se in bolo e/o alte dosi). Come tutti gli ipnotici un po' ipotende; in più, essendo lipofilo, passa la BEE e interferisce con CTZ (sdr PONV)
...
![L'anestetico dei sogni nel mondo perfetto](img/anestetico-dei-sogni.png)
...
- Somministrati con ventilatore a circuito chiuso, che permette di monitorare precisamente ET e MAC [^b210] (e, da qui, aggiustare la Fi di gas per ottenere la profondità anestesiologica desiderata)
...
###### Effetti collaterali
- ⚠ **Ipertermia maligna** (necessaria predisposizione genetica e R > se uso combinato con altri farmaci (`succinilcolina`))
...
- 2 famiglie, in funzione del MdA
	- **Bloccanti non depolarizzanti** (*curari*) → antagonisti diretti dell'ACh, bloccando l'eccitazione del neurone postsinaptico
	- **Bloccanti depolarizzanti** (`succinilcolina`) → induce depolarizzazione continua e costante del neurone postsinaptico
- Farmaci difficili: usarli sempre avendo antidoto specifico a disposizione (`sugammadex` per curari, *colinesterasi* per `succi`) e, idealmente, TOF
...
- Scegliere sse **opportuno r/b** (ortopedia, dermatologia, ginecologia) **o come *aiuto* in situazioni specifiche** (es: *blocchi nervosi per controllo del dolore* postoperatorio)
- Aspetti dell'AG che è necessario vengano preservati in AL: **analgesia e inibizione dei riflessi**
- MdA: agenti sui canali Na^+^ voltaggio-dipendenti, per bloccare la trasmissione del PdA e dell'onda di depolarizzazione [^b211]
	- Durata breve → `procaina`
	- Durata intermedia → `lidocaina` (⚠ antiaritmico 1B!), `mepivacaina`
	- Durata lunga → `bupivacaina`, `ropivacaina`
- 3 tipologie di AL
	1.  Topica → realizzata infiltrando in loco l'anestetico
...
- Come tutti i cortisonici hanno *azione lenta*: onset dopo 24h, efficacia tp max dopo \> 1w

:::{.callout-warning}
consigliare sempre risciacquo della bocca, per evitare che il cortisone che si deposita nel tratto GI espleti lì l'azione anti-infiammatoria e favorisca le micosi orali/disfonia/tosse
:::
...
- MdA: **antagonisti *selettivi* e competitivi dei recettori dei LT**, spegnendo l'infiammazione che questi promuovono e bloccando la loro fisiologica azione broncocostrittrice. Inoltre: ↓ produzione di muco, **inibizione degli eosinofili/mastcellule** (che sono i maggiori produttori di LT)
...
### Antiacidi
- `NaHCO3`, `CaCO3`, sali di alluminio, **sali di magnesio**
- OTC
...
:::{.callout-note}
I recettori istaminergici del SNC e implicati nella risposta allergica sono i **recettori H~1~** (antistaminico per atopia è anti-H~1~ periferici)
:::
...
- Substrati *e inibitori* del CYP2C19 (quindi considerare attentamente le interazioni, non dare come acqua fresca alla qualunque)

:::{.callout}
###### Note di prescrivibilità
Per grande prevalenza (~ 50%) e prescrizione spesso inappropriata, AIFA ha emesso 2 sole indicazioni di prescrivibilità:

1.  Trattamento cronico con FANS
2.  Trattamento antiaggregante con cardioASA
...
###### Effetti collaterali
- ⚠ **2x RR CAP nell'anziano** *dopo* tx con PPI
- **Nefrotossicità** (↓ eGFR in pz. \> 6m di trattamento *cumulativo*)
- +RR di caduta e frattura (correlazione epidemiologica)
- +RR demenza (OR 1.6---1.8 in *piccoli studi*. Modelli murini dimostrano ↑ β-amiloide)

![Nell'ambito di una tp. razionale bisogna sempre prevedere momenti di *riconciliazione terapeutica*, dove si valuta se la tp. corrente rimane adeguata alle necessità cliniche del paziente. **↑ Algoritmo di deprescrizione dei PPI**](img/deprescrizionePPI.png)

### Altri farmaci

###### PGE~2~
- `misoprostolo` (⚠ induce travaglio attivo)
...
1.  Sistema vestibolare (recettori H~1~ e M~1~)
2.  CTZ [^b212] (recettori D~2~, 5-HT~3~, NK1-r [^b213], H~1~, M)
3.  Sistemi nervosi integrati (con info da sens viscerale)
:::
...
- CHT induce CINV (Cht-Induced Nausea and Vomiting ↑ principalmente stimolando, direttamente *e indirettamente*, la CTZ
- 3 ppaa utili in questo setting (in ordine di scelta; considerare combo in base a r/b)
	1.  Anti**dopaminergici** (`metoclopramide` e `domperidone`)
		- EV/PO
		- ⚠ EPS (parkinsonismo, distonia, acatisia, discinesia tardiva, [rabbit sdr](https://youtu.be/e-bmcrN0pY8))
		- ⚠ ↑ QT
	2.  Anti**serotoninergici** (`ondansetron`)
		- EV/PO
		- Eeaa: stipsi, cefalea
		- Metabolismo: CYP3a4 e CYP2D6
	3.  Anti**NK1-r** (`aprepitant`)
...
- **Osmotici** (`lattulosio`, `macrogol`) \[⚠ elettroliti\]
...
+======================+======================+=======================+
| **Inibitori della	   | 1/a				  | `tacrolimus`		  |
| calcuneurina**	   |					  | `ciclosporina`		  |
+----------------------+----------------------+-----------------------+
| **Inibitori di	   | 2/a				  | `sirolimus`		      |
| mTOR**			   |					  | `everolimus`		  |
+----------------------+----------------------+-----------------------+
| **Inibitori della	   | 3/a				  | `micofenolato`[^b214] |
| proliferazione	   |					  | `metotrexato`		  |
| cellulare**		   |					  |					      |
+----------------------+----------------------+-----------------------+
...
|-|-|
| B- lattamine | Macrolidi |
| Glicopeptidi | Lincosammidi |
| Lipopeotidi | Oxazolidinoni |
| Amminoglicosidi | Tetracicline |
| Chinoloni e fluoro- | Cloramfenicolo |
| Cotrimossazolo | Cloramfenicolo |
| Rifampicina | Sulfamidici |

:::{.callout-caution}
Ogni volta che si prescrive un'antibiotico, si selezionano resistenze (perché si esercita una pressione selettiva). **L'uso corretto [minimizza]{.underline} questo rischio**. Prescrivere abx è un'azione che impatta la salute pubblica.
:::

:::{.callout-warning}
__*Acinetobacter baumannii*, *Pseudomonas aeruginosa*, *Enterobacteriacee spp* sono ad oggi i 3 patogeni più preoccupanti per una pan-resistenza anche ai carbapenemi__ (OMS 2017)
:::
...
- **AmpC** --- prodotte da *Enterobacter*, *Serratia*. Trasmesse verticalmente (bene), ma sono capaci di inattivare i carbapenemi (malissimo)

###### Efficaci vs carbapenemi e a trasmissione orizzontale (fuck), ma neutralizzabili da inibitori delle B-lattamasi rescue
- **KPC** --- prodotte da *Klebsiella spp*, inattivano i carbapenemi
- **NDM** --- metallo-B-lattamasi
- **OXA 48** --- inattivano tutti i B-lattamici

###### Efficaci contro tutto e non neutralizzabili ad oggi
- **Metallo B lattamasi**
:::

- Nell'ambito delle crescenti resistenze, **per aumentare l'efficacia dei B-latt [in situazioni specifiche]{.underline} si può considerare la co-somministrazione con inibitori delle β-lattamasi**, enzimi che degradano facilmente l'anello B-lattamico degradando l'abx
...
- La FK, negli aspetti comuni, deriva principalmente dal fatto che i **B-l sono idrofili**
	...
	- (M) Sostanzialmente *non epatico* (poche interazioni)
	- (E) prevalentemente renale in forma immodificata (⚠ aggiustamento posologico in GFR **↓**/↑)
		- Per GFR ridotte: ↓ dose/die (ma mirare a minimizzare gli intervalli di somministrazione
		- Per GFR aumentate (sepsi iperdinamiche, ustioni, politraumi, pz. sotto vasopressori, pz. con disfunzioni autonomiche [emorragie subaracnoidee]) si ha un > RR di fallimento tp.: considerare ↑ dose (o meglio, siccome aumenta la Cl, considerare somministrazioni più ravvicinate)
...
:::{.callout-note}
Una roba da tenere in considerazione dei B-lattamici è che sui batteri che producono tossine, portandoli a morte cellulare *per lisi*, possono causare un'improvvisa liberazione delle tox batteriche che, a volte, potrebbe essere *correlato* a quadri di **tempesta citochinica**
:::
...
- (E) Renale (⚠ ↓ GFR). `piperacillina`: anche per via biliare (ottima per colangiti)
...
| Gen				   | Uso				  | Es					  |
+======================+======================+=======================+
| 1					   | Profilassi in *ch	  | `cefazolina`		  |
|					   | pulita* per ottima   |					      |
|					   | efficacia vs		  |					      |
|					   | microbiota cutaneo   |					      |
+----------------------+----------------------+-----------------------+
| 2					   | Simile alla 1, ma	  | `cefoxitina`		  |
|					   | `cefoxitina` ha	  |					      |
|					   | efficacia anche vs   |					      |
|					   | microbiota		      |					      |
|					   | intestinale (top per |					      |
...
|					   | intraddominali)	  |					      |
+----------------------+----------------------+-----------------------+
| 3 ★				   | Patologie			  | - `cefotaxime`,	      |
|                      | comunitarie,		  |	 `ceftriaxone`:	      |
|                      | *Pseudomonas* non	  |	 Infezioni		      |
|					   | resistente,		  |	 comunitarie	      |
|					   | meningiti			  |	 (Pneumococco,	      |
|					   | comunitarie		  |	 Haemophilus,	      |
|					   |					  |	 Meningococco,	      |
|					   |					  |	 Gram^neg^,...)	      |
|					   |					  |					      |
|					   |					  | - `ceftazidime`:	  |
|					   |					  |	 Pseudomonas	      |
+----------------------+----------------------+-----------------------+
| 4					   | vs *Pseudomonas	  | `cefepime`			  |
|					   | aeruginosa*		  |					      |
+----------------------+----------------------+-----------------------+
| 5					   | vs MRSA			  | `ceftobiprolo`,	      |
|					   |					  | `ceftarolina`		  |
+----------------------+----------------------+-----------------------+
...
### Carbapenemi
- "-penem"
- Spettro d'azione *estremamente* ampio, ed molto resistenti alle β-lattamasi (sono tp. rescue per infezioni resistenti)
...
- In casi di particolare resistenza: associazione con *nuovi* inibitori delle B-lattamasi (`avibactam`, `relebactam` (imipenem), `vaborbactam` (meropenem))

###### Indicazioni terapeutiche
- Spp resistenti ad altro, ma non ai carbapenemi (*Enterobacter* esbl, *Acinetobacter*, *Pseudomonas*
...
- *Pseudomonas aeruginosa* (`amilkacina` + `piptazo` \| cefalosporine \| carbapenemi)
	- Pseudomonas in fibrosi cistica: aerosol ad alta pressione con `tobramicina`

:::{.callout-tip}
l'associazione con un B-lattamico è da considerare in casi specifici (pz. neutropenico HR). Questo rende efficace gli amminoglicosidi anche in contesti anaerobi o di difficile ingresso nel batterio, per via dell'azione B-lattamica che indebolisce la parete batterica
:::
...
- Spettro d'azione: dipende dalla molecola, ma generalmente *Pseudomonas* e *Pneumococco*
...
###### Farmacocinetica
- (A) ottima biodisponibilità; ma *chelano il calcio* (se li bevo con il latte, li cago via con il latte)
...
:::{.callout-warning}
il pz. tipo che ha eeaa da fluorochinoloni è anziano, con IR, in co-tp. con corticosteroidi
:::

###### Indicazioni terapeutiche
- **CAP**, [anche da patogeni intracellulari]{.underline} (non in TAO `warfarin`)
- **IVU**
- **Prostatiti**
- *Osteomieliti* (spp da MSSA)
- IST
- Infezioni cutanee
- Infezioni GI
- TBC
...
- (M/E)
	...
	- `claritromicina` → CYP3A4 (che inibisce) ⇒ ⚠ interazioni!
...
:::{.callout-note}
L'`azitromicina` ha un V~D~ enorme: questo significa che virtualmente non c'è farmaco in giro ma è tutto dentro alle cellule, a fare da riserva per rilascio prolungato. Questo spiega la sua posologia tipica (3 monosomminstrazioni per 3 giorni, per ottenere una copertura reale di 5-7gg)
:::
...
###### Indicazioni terapeutiche
- Prevenzione della **Toxic Shock Syndrome da Staph**: sdr con shock settico da tossine di Staph (`clindamicina + linezolid`) [^b218]
- **aBSSSI gravi**[^b219]. Es: fascite necrotizzante (`clindamicina + amoxicillina`)
...
###### Farmacocinetica
- (A) biodisponibilità ottima, ma ⚠ chelano cationi (**Ca**)
...
###### Effetti collaterali
- **Alterazione dell'accrescimento osseo** per chelazione del Ca^++^ (controindicati in ped < 8aa)
...
- Spettro d'azione: molti morg Gram^pos^ e Gram^neg^ MDR (produttori di carbapenemasi, MRSA, `vanc`-resistenti...)
- Tempo-dipendente (IV q4h)
- Spesso associato ai B-lattamici
- ⚠ Notevole quantità di Na^+^ in molecola
...
- **Tempo-dipendente**
- Resistenze preoccupantemente in aumento in ambito ospedaliero: *Staph a.* VR [^b310], *Enterococco* VR (per cambio di target)
...
- Colite pseudomembranosa da *C difficile* (topico)

## Lipopetidi
- `daptomicina`
- MdA: **porazione della parete cellulare**, provocando la morte del batterio *senza lisi* [^b311]: la catena lipopeptidica si incunea nella membrana, anche se per concludere la porazione sono necessari ioni Ca^++^
...
###### Farmacocinetica
- \(D\) 92% legata con carrier (*albumina*), T~1/2~ 7---9h
- \(E\) renale

###### Indicazioni terapeutiche
- Infezioni Gram^pos^ MDR, anche in co-somministrazione
	- ★ Batteriemie, endocarditi (perché raggiunge ottima C~max~ in comparto vascolare)
	- aBSSSI
...
- *-vancina*: `dalbavancina`, `oritavancina`
- Cinetica estremamente particolare: **tempo-dipendente con caratteristiche di concentrazione-dipendenza**
	- ★ Azione "**long-acting**": (si può fare **dose unica** \~ 1,2/1,5g, producendo un effetto post-abx molto prolungato) [^b312]
...
###### Effetti collaterali
- __Inibizione collaterale della catena di respirazione mitocondriale__
	- Piastrinopenia dose-dipendente
	- Neuropatie periferiche
	- ⚠ Acidosi lattica (come metfomrina)
- __⚠ Effetto *IMAO* ⇒ ↑↑ RR sdr serotoninergica quando co-tp. con antidepressivi__
...
:::{.callout-warning}
MTB con gene **KatG**^mut^ sviluppano subito resistenza ad `isoniazide`, quindi **non va mai usata in mono-tp.**
:::

###### Farmacocinetica
- \(A\) ↓ F~PO~ se concomita (\~ 2h) pasto glucidico
- \(D\) Non si lega ai carriers ⇔ ottima distribuzione in ogni distretto (liquor compreso [^b313])
- \(M\) Per via enzimatica (*N-acetil-transferasi-II*, NAT2)
...
:::{.callout-warning}
###### Epatotossicità
Nel metabolismo si possono produrre metaboliti tossici, perché **una delle** [^b314] vie metaboliche dell'isoniazide (quella che coinvolge CYP2E1, percorsa quando la via enzimatica viene saturata) termina con la produzione di **epatotossina**.
...
- ⚠ **Epatotossicità** (spp se lesione epatiche preesistenti o alte dosi o con `isoniazide`)
...
:::{.callout-note}
Morg con gene **emb^mut^** sono a rischio di sviluppare resistenza (*ma su lunghe esposizioni*)
:::
...
###### Effetti collaterali
- Iperuricemia (50%)
- Neurite ottica retrobulbare dose-dipendente e reversibile (1%, *fare periodicamente fondo oculare*)

:::{.callout-warning}
Usare a dosi considerevolmente \< se IR (e fare controlli periodici). MAI in pz. \< 6aa
:::
...
- 4 classi
	...
	2.  **Azoli** --- bloccano la sintesi dell'ergosterolo, necessario per la costruzione della membrana plasmatica
	3.  **Polieni** --- si legano all'ergosterolo già messo in membrana, alterandone la tensione superficiale
	4.  **Fluoropirimidine** --- antimetaboliti inibitori della sintesi degli acidi nucleici

![](img/mda-antifungini.png)

## Echinocandine {#_echinocandine}
...
- Attivi in teoria contro tante spp, in pratica solo vs Candida e Aspergillus
	- *Candida spp* (1/a scelta)
	- *Aspergillus spp* (2/a linea)
- **Concentrazione-dipendenti**
...
###### Effetti collaterali
- ⚠ Tutti potenzialmente epatotossici, tranne `anidulafungina` (unico da usare in insufficienza epatica)
...
- Classe che comprende gli imidazoli e i triazoli (`-conazolo`)
	...
	- Triazoli → `itraconazolo`, `posaconazolo`, `voriconazolo`, `isavuconazolo`, `fluconazolo`
		- `fluconazolo` --- efficace solo su *Candida spp* (tranne *C. glabrata* e *C. krusei*)
		- `voriconazolo` --- efficace *anche* in infezioni da *Aspergillus* e *Mucorales*
...
- (D) basso legame con proteine plasmatiche, *eccellente diffusione in siti difficili* (occhio, SNC). T~1/2~ \~ 24h
...
:::{.callout-notertip}
Nel tentativo di ridurre la tossicità sono in uso formulazioni lipdiiche alternative che migliorano il rilascio del principio attivo solo sul target fungino ("formulazioni liposomali", ↓ di x40-50 il V~D~)
:::

###### Indicazioni terapeutiche
_Solo quando r/b favorevole nonostante nefrotossicità)_

- Micosi sistemiche (e/v)
- *Leishmaniosi viscerale* (protozoosi)
...
:::{.callout-warning}
I virus hanno una grandissima capacità mutagena, quindi è essenziale che il farmaco dimostri di essere barriera efficace vs resistenze.
:::
...
- Off label: efficacia anche vs HSV *a dosi maggiorate*
...
- Normale ciclo di vita dei retrovirus: prevede integrazione nel genoma dell'host e sfruttamento della sua macchina di replicazione cellulare
	1.  retrotrascrizione dell'RNA virale a DNA mediante *trascrittasi inversa*
	2.  integrazione del DNA retrotrascritto nel genoma della cellula host tramite *integrasi*
...
![NB: l'esistenza di tanti farmaci antiretrovirali permette di sostenere una tp. che sarà a vita, bilanciando r/b in funzione dell'aggressività necessaria e della fase della storia naturale dell'infezione](img/antiretrovirali.png)
...
- MdA: inibizione della trascrittasi inversa sul sito attivo o sul sito allosterico
	...
	- NRTI --- inibitori nucleo*tidici* che agiscono sul sito attivo
	- NtRTI --- inibitori nucleo*sidici* della trascrittasi inversa
...
- Malaria è patologia da infestazione di protozoi del genere *Plasmodia*
...
- Tp. antimalarica può essere di attacco o di profilassi
	- **Di attacco**: tp. tipicamente con agenti vs schizoonti ematici; schizoonti extra-ematici solo per eradicare *P vivax* e *P ovale*
...
+----------------------+----------------------+-----------------------+
| Zona A			   | Basso rischio, bassa | `clorochina`		  |
|					   | resistenza		      |					      |
+----------------------+----------------------+-----------------------+
| Zona B			   | Basso rischio,	      | `clorochina` ±		  |
|					   | possibile resistenza | `proguanil`; oppure   |
|					   |					  | `meflochina`		  |
+----------------------+----------------------+-----------------------+
| Zona C			   | Alto rischio,		  | `meflochina` oppure   |
|					   | probabile resistenza | `clorochina` +		  |
|					   |					  | `proguanil`		      |
+----------------------+----------------------+-----------------------+

: Strategia di PrEP in base al rischio (incidenza _e_ possibilità di resistenza)
...
- MdA: blocco della respirazione mitocondriale del *Plasmodium*
...
![](img/meccanismi-farmaci-antineoplastici.png)
...
- Gestione aggressiva e precoce degli eeaa
:::
...
:::{.callout}
###### Meccanismi che determinano il danno genetico dovuto ad addotti
...
- MdA: alchilante bifunzionale (2 gruppi alchilanti, che possono agire contemporaneamente su *entrambe* le catene del DNA ⇒ riparazione meno efficace)
...
- **Acroleina** (prono all'accumulo vescicale ⇒ cistite emorragica \[⚠ \> 40% letalità in forme gravi!\])
...
###### Indicazioni terapeutiche
- Neo solide
- Neo ematologiche (tutte, di fatto: ALL, AML, CLL, HL, NHL)
...
- Azione perdura x3m
- Imperativo TDM, specialmente nel contesto del trapianto di midollo, specialmente in ped [^b317]
...
###### Farmacocinetica
- \(E\) esclusivamente renale tramite trasportatori attivi ⚠

:::{.callout-tip}
###### Cinetica di eliminazione del mtx
![](img/mtx-dosaggi.png)
...
- Durante il metabolismo delle antracicline, specialmente nei cardiomiociti, vengono prodotti **metabiliti intermedi ossidanti** (semichinoloni) e **ROX**
	- **Cardiotox dose---dipendente e cumulativa**
		- Se dose somministrata *a vita* \> 550 mg/m^2^ ⇒ RR di cardiomiopatia dilatativa irreversibile con HF marcatamente ridotta e alta letalità
		- Somministrazione *lenta* ↓ tox acuta, ma non impatta su tox cumulativa
...
![](img/meccanismi-resistenza-tumorale.png)

1.  Impedire l'ingresso del farmaco
	- Se entra come trasportatore → ridurne l'espressione
	- Se entra per diffusione → potenziare l'espressione di pompe di efflusso (*MDR proteins*)
2.  Alterare le vie metaboliche
3.  Sequestro lisosomiale del farmaco e sua distruzione
4.  Pompe di efflusso nucleari (*vaults proteins*)
...
|					   |					  |	 antracicline	      |
+----------------------+----------------------+-----------------------+
| `pertuzumab`		   | **HER2** (k mammario |					      |
|					   | recidivante o		  |					      |
|					   | metastatico)		  |					      |
+----------------------+----------------------+-----------------------+
| `cetuximab` e		   | **EGFR** (neo		  | Eeaa				  |
| `panitumumab`		   | solide, spp k colon) |					      |
|					   |					  | - Sdr peri		      |
|					   |					  |	 infusionale	      |
|					   |					  |					      |
|					   |					  | - Reazioni		      |
|					   |					  |	 anafilattiche	      |
+----------------------+----------------------+-----------------------+
| `bevacizumab`		   | **VEGF** (neo		  | Eeaa				  |
|					   | solide, spp k colon, |					      |
|					   | NSLCL, glioblastoma, | - Ipertensione	      |
|					   | K renale; ma anche   |					      |
|					   | degenerazione		  | - Tromboembolismo     |
|					   | maculare)			  |					      |
|					   |					  | - Emorragia		      |
+----------------------+----------------------+-----------------------+
| `ipilimumab`		   | **CTLA4**,		      | Eeaa				  |
|					   | checkpoint dei lfc T |					      |
|					   | (melanoma in stadio  | - Prurito		      |
|					   | avanzato)			  |					      |
|					   |					  | - Eruzioni cutanee    |
|					   |					  |					      |
|					   |					  | - Colite, diarrea     |
+----------------------+----------------------+-----------------------+
| `nivolumab`		   | **PD1**, checkpoint  | Eeaa				  |
|					   | dei lfc T (melanoma  |					      |
|					   | avanzato, NSCLC, k   | - Eruzioni cutanee    |
|					   | testa/collo		  |					      |
|					   | avanztati, LH		  | - Diarrea, colite     |
|					   | refrattario)		  |					      |
+----------------------+----------------------+-----------------------+
...
- Bradicardia
- Sonnolenza (fino a *coma mixedematoso*)
- ↑ peso
:::
...
- T3 sost: `liotironina`; T4 sost: `levotiroxina`
...
- Diarrea
- Dimagrimento
- Cardiopalmo → aritmia (⚠ No in angina instabile o HF)
...
- Più linee di intervento
	...
	2.  Preparati **a base di iodio**
		- Ioduri --- MdA: riduzione del rilascio degli ormoni per feedback e ↓ dimensioni e vascolarizzazioni della tiroide. Incompatibili con iodio radioattivo. Da usare *dopo* inizio tp. con tionamidi
		- ^131^I --- MdA: distruzione dei tireociti (*molto specifica e rapida*)
...
:::{.aside}
![Asse ipotalamo → ipofisi → organi sessuali](img/asse-iio.png)

###### Fisiologia degli ormoni estrogenici
...
###### Controindicazioni
- ⚠ MAI in neo estrogeno---dipendenti (K endometrio o mammella)
...
:::{.callout-tip}
###### Quando scegliere i POPs rispetto agli E/P
...
###### Effetti avversi
- ⚠ TEV (↑ RR è max per la formulaizone 50 μg etilestradiolo/levonorgestrel. ↑↑ in pz. fumatrici)
...
- In ITA: somm max entro 63/mo g dall'ultimo ciclo mestruale (9 settimane) [^b318]
- Da agosto 2020: possibile somministrare in regime di day-H o strutture ambulatoriali/consultoriali adeguate. Prima era solo H\_
...
###### Effetti del testosterone {.aside}
...
NB: testosterone --- *5-α-reduttasi* → diidrotestosterone (attivo)

###### Indicazioni terapeutiche
- Tto sostitutivo in M (ipogonadismo o pubertà ritardata), rimborsato SSN nell'ambito di [nota AIFA 36](https://www.aifa.gov.it/nota-36)
...
###### Controindicazioni
- K prostatico (ha effetto trofico sulla prostata)
- K mammella
- Gravidanza
- Ped
...
- L'approccio farmacologico all'osteoporosi si divide in farmaci che bloccano gli osteoclasti e farmaci che potenziano gli osteoblasti
	- **Farmaci che bloccano l'attività degli osteoclasti** ("antiriassorbenti")
		...
		- mAb
		- TOS per estrogeni (⚠ Non utilizzabile per *prevenzione*, perché r/b non è favorevole \[\> R di k mammella\])
...
- 3 generazioni (`-dronato`)
	...
	2.  II e III gen (*amino*-bifosfonati [^b319]) → `alendronato`, `risedronato`

###### Farmacocinetica
- \(A\) F~OS~ \< 1.5% (\_mai somministrare con antiacidi che ↓ F~OS~)
- \(M\) tempi di metabolizzazione *lunghissimi* [^b410]⇒ somm 1/w

###### Indicazioni terapeutiche
- osteoporosi
- neoplasie ossee (\>\> dose)
- malattia di Paget [^b411]

###### Effetti avversi
- **Irritazione esofagea** (esofagiti, fino ad ulcere) [^b412]
...
- MdA: stimolazione della proliferazione di osteoblasti [^b413]
- `raloxifene` (↓ R frattura di osso trabecolare, ma non previene frattura d'anca [^b414])
- ↑ TEV
...
[^b11]: Attenzione alle alte dosi: **rischio di ostruzione delle vvaa in combinazione con l'azione sedativa**
[^b21]: Preferire altri ppaa per l'ansiolisi di durata (SSRI/SNRI) in primis). Considerare principalmente per il trattamento *acuto* dell'ansia
[^b31]: Effetto rebound (o fenomeno di rebound) = il ripresentarsi o l'inasprimento di una malattia dopo la sospensione di un trattamento farmacologico o la riduzione del suo dosaggio. La gravità dei sintomi è spesso peggiore rispetto ai livelli di trattamento
[^b41]: Gli antipsicotici IIgen antagonizzano anche recettori muscarinici, adrenergici (calo delle resistenze periferiche) e istaminergici (assunzione di cibo +, dislipidemia, sedazione)
[^b51]: Questo significa anche (confermato da metanalisi in let) che somministrare farmaci con azione anticolinergica predispone a demenza: somministrazione per 1---3aa di farmaci anti-ch ⇒ RR +39%
...
[^b113]: L'ipotesi è che il meccanismo sia legato all'alterazione dei processi di degradazione di bradichinina e altre sostanze, come la sostanza P. Fisiologicamente, queste sostanze vengono degradate ad opera di chininasi, inibite iatrogenicamente dall'azione degli ACE-inibitori. Si ha quindi un'aumentata produzione di bradichinina e sostanza P, che non possono essere degradate, e l'eccesso stimola recettori a livello di apparato respiratorio con induzione di tosse secca, ulteriormente potenziata dal fatto che la bradichinina induce la liberazione di acido arachidonico per stimolazione della fosfolipasi cellulare, capostipite della produzione di prostaglandine, prostacicline e trombossani. In particolare, la prostaglandina PGF2A va a potenziare ulteriormente l'effetto tussigeno
[^b114]: Nati come antidiabetici franchi, si è visto che hanno anche azione diretta e protettiva contro lo scompenso
[^b115]: Divisi in maggiori (trauma, grande ch, immobilità prolungata) e minori (piccola ch, ammissione in H, tp. con estrogeni, gravidanza, mobilità ridotta)
[^b116]: Adenosin-di-fosfato è DAMP!
[^b117]: `sotalolo` è βb usato solo come antiaritmico, per un profilo di rischio inaccettabilmente alto
[^b118]: Ad oggi `simvastatina` è in commercio con dose max di 40mg proprio per il rischio di miopatia
[^b119]: Iperpolarizzazione → liberazione di Ca^++^ → aumentata fusione delle vescicole esocitotiche con la membrana plasmatica
[^b210]: **MAC** (Min Alveolar Concentration):: concentrazione di gas anestetico che, alla pressione di 1atm, produce anestesia in 50% dei pz. esposti
[^b211]: fun fact, derivano funzionalmente dalla cocaina
[^b212]: Chemoreceptor Trigger Zone
...
[^b310]: Vancomycin-Resistant
[^b311]: Quindi verosimilmente riduce la tempesta citochinica che si ha quando si ha la porazione *con lisi* della parete cellulare (es: B-lattamici)
[^b312]: AUC ($AUC = \frac{\text{Dose}}{\text{Cl}}$) tra 1500 mg e 1000 + 500 mg è sovrapponibile --- e, anzi, leggermente maggiore nella somministrazione in dose unica per il prevalere dell'aspetto di concentrazione-dipendenza
[^b313]: Ottimo per le situazioni, frequenti in immunodepressi, in cui TBC secondaria dà focolai cerebrali
[^b314]: ![metabolismo isoniazide](img/metabolismo-isoniazide.png)
[^b315]: Codifica per subunità β della RNApol
[^b316]: ![tropismofunghi](img/tropismofunghi.png)
[^b317]: Nel pz. ped c'è una variabilità estema in termini di farmacocinetica
[^b318]: IVG può essere fatta entro 90g dall'ultima mestruazione. Entro il 63mo giorno l'IVG può essere farmacologica, poi dev'essere chirurgica (isterosuzione o raschiamento)
[^b319]: Introduzione di gruppo aminico ↑ potenza
[^b410]: A IHC si evidenziano su osso anche fino a 10aa
[^b411]: La malattia di Paget dell'osso è una patologia cronica dello scheletro dell'adulto in cui il turnover osseo è accelerato in alcune aree definite. La normale matrice è sostituita da osso indebolito e rarefatto. La malattia può essere asintomatica o provocare insorgenza graduale di dolore osseo o deformità. La diagnosi è effettuata con la RX. La terapia comprende misure sintomatiche e spesso farmaci, in genere bifosfonati. (MSD manual)
