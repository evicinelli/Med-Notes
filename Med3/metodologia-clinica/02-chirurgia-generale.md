...
![](img/sindrome-compartimentale.png)\ 
...
![](img/linee-semeiotica-torace.png)\ 
...
![Pazienti iscritti in lista d'attesa per trapianti (2002--2015)](img/gap-trapianti.png)
...
![\label{atptissutaleconservazioneespianto} Quantificazione dell'ATP tissutale in funzione delle differenti metodiche di conservazione (more is better)](img/atp-tissutale-per-metodica-conservazione-organo-espiantato.png)
...
![No-touch period nei vari paesi EU \label{notoucheu}](img/dcd-no-touch-time.png)
...
flowchart TB
	...
	freddo --> agoaspirato
	scintigrafia --> caldo
	caldo --> ipertiroideo --> chirurgia
	caldo --> eutiroideo --> follow

	agoaspirato --> diagnostico
	agoaspirato --> non_diagnostico
	diagnostico --> benigno
	...
	sospetto --> chirurgia
	maligno --> chirurgia
	non_diagnostico --> ripetere[Ripetere ago aspirato]

style chirurgia fill:#f55
style follow fill:lightblue

diagnostico[È diagnostico - 85%]
non_diagnostico[Non è diagnostico - 25%]
follow((Follow up))
chirurgia((Chirurgia))
nodulo([Riscontro di nodulo tiroideo])
