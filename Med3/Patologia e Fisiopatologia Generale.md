...
> queste eziologie portano ad ipotermia }
  ...
  --------------- ------------------------------- -------------------------------- ------------------------------
  Febbre erratica Unico picco piuttosto alto (\~  ![](img/febbre-erratica.png)     Da microorganismi batterici
                  39), preannunciato da brividi,                                   ectopici (= infettano fuori
                  che poi scompare. Può                                            dalla loro sede). Es: cistite
                  facilmente recidivare se, per                                    da *E. coli*
                  qualsiasi situazione, cala                                       
                  momentaneamente la fitness                                       
                  immunitaria o la noxa diventa                                    
                  improvvisamente più virulenta                                    
                  (solitamente perché trova nuova                                  
                  sede adatta)                                                     

  Febbre          Alternanza *regolare* di brevi  ![](img/febbre-periodica.png)    Da plasmodii[^174]
  periodica       periodi di apiressia e di                                        
  intermittente   piressia, spesso preceduta da                                    
                  brivido                                                          

  Febbre          Periodi (3--5gg) di piressia    ![](img/febbre-ricorrente.png)   Tendenzialmente borreliosi
  ricorrente      con varie oscillazioni, che si                                   
                  ripresenta dopo periodi di                                       
                  apiressia irregolari.                                            
                  Defervescenza per crisi,                                         
                  seguita da rialzo graduale                                       
                  della TC                                                         

  Febbre          Periodi febbrili lunghi (fino   ![](img/febbre-ondulante.png)    Tipica di infezioni da
  ondulante       14gg) con oscillazioni                                           *Brucella*
                  consistenti seguiti da periodi                                   
                  più brevi di apiressia.                                          
                  Defervescenza per lisi                                           

  Febbre          Febbre grossolanamente          ![](img/febbre-ondulante.png)    
  ondulante da    ondulante ma con frequentissima                                  
  linfoma di      variabilità di temperatura                                       
  Hodgkin         (perché moltissimi                                               
                  fattori[^175] concorrono alla                                    
                  febbre tumorale). Andamento                                      
                  definito a spike                                                 

  Febbre continua Periodo continuo di piressia    ![](img/febbre-continua.png)     *Diplococcus pneumoniae*
                  con oscillazioni giornaliere                                     
                  modeste (≤ 1°C). Cade per crisi                                  

  Febbre          Periodo continuo di piressia    ![](img/febbre-remittente.png)   *Streptococcus β-emolitico*
  remittente      con oscillazioni giornaliere                                     
                  consistenti (> 1°C). Caduta per                                  
                  crisi                                                            
  ---------------------------------------------------------------------------------------------------------------
