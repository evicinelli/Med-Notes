...
* Albumina (⇒ __differente cinetica dei farmaci__ che necessitano carrier)
...
### Patogenesi del danno del parenchima
...
* In base alle lesioni evidenziabili all'ottica (ME meglio che MO, fluorescenza tipicamente ok tranne che nelle forme primitive idiopatiche^[Si individua spesso accumulo di citochine nel gomerulo, tipo C3, CLC1, citochine della famiglia dell'IL-6...]) si individuano 5 sottotipi anatomopatologici di GSSF
...
* Una parte (< 1/3) dei casi regredisce spontaneamente. In 2/3 si assiste ad un progressivo declino della funzione renale fino a necessità di dialisi
...
#### GN membrano--proliferativa (anche "mesangio-capillare") {#gnmp}
...
* Patogenesi
	...
	2. I recettori Toll-like orchestrano la produzione di anticorpi _pluriclonali_ vs gli elementi originariamente intracellulari ⇒ si perde la tolleranza verso il self
...
###### LES: criteri renali per definire la riacutizzazione
* ↓ VFG con crea +30%
...
* Tto: in funzione del quadro bioptico (correla con severità, e quindi con aggressività terapeutica)
...
### Nefrite (interstiziale, ma non solo) da accumulo di catene leggere
...
#### Nefriti interstiziali immunomediate da Ig-G4
...
* Hp patogenetica nella sdr di Alport: __anomalia nelle catene a3, a4, a5, e a6, che porta al fallimento dello switch isotipico__
...
![Le amiloidosi sono per la maggior parte rappresentate da forme sistemiche. L’amiloidosi legata alle __catene leggere delle immunoglobuline__ è correlata a discrasia plasmacellulare, quindi patologie ematologiche come *plasmocitoma,* *mieloma* (anche se il mieloma ha altre caratteristiche), *gammopatia monoclonale di significato incerto (MGUS)*. Abbiamo poi **forme reattive date da infiammazioni croniche** che portano ad accumuli su rene, fegato, milza, surrene. Anche la **dialisi** può portare ad amiloidosi in quanto le membrane con cui viene a contatto il sangue, pur essendo ampiamente biocompatibili, rappresentano pur sempre un materiale non completamente biologico che può stimolare infiammazione cronica. In questo caso, la proteina precursore è la β2- microglobulina. Si trovano anche forme familiari legate ad un’ereditarietà autosomica recessiva, come quella associata alla febbre mediterranea con patologie polmonari e renali. La proteina implicata nel processo è chiamata marenostrina ed è legata a forme presenti in popolazioni che vivono sul bacino del Mediterraneo (negli ebrei sefarditi, arabi, armeni ecc...). Un altro esempio sono le amiloidosi date da transtiretina (proteina prodotta dal fegato che serve a trasportare la tiroxina e le proteine che legano il retinolo, cioè la vitamina D), una forma associata ad alterazioni di tipo genetico in cui si ritrova un forte l'effetto fondante in alcune famiglie. In quest’ultimo caso il quadro clinico è importante e ben preciso e coinvolge sistema nervoso autonomo e periferico (sindrome del tunnel carpale, impotenza, alterazioni della motilità intestinale, deficit di forza etc..). Poi c’è la forma senile, cioè legata all'invecchiamento per il deterioramento dei vari organi: in questo caso non c'è una proteina precursore quanto una sclerosi delle fibrille, anche amorfe, che sono presenti nei vari tessuti nell’invecchiamento. 2Le sedi sono varie, per cui ne citeremo solo alcune. Possiamo avere amiloidosi isolate, cerebrali legate alla malattia di Alzheimer dove si accumulano queste proteine a livello della amigdala nella neurocorteccia, troviamo encefalopatie spongiformi ecc…](img/amiloidosipatogenesi.png)

:::

* __Nefropatia *glomerulare* causata da una sclerosi del glomerulo, con conseguente sdr nefrosica. La sclerosi è dovuta all'accumulo nel glomerulo di *proteina amiloide*__
...
* Dx: anamnesi, biopsia, test lab, test genetici per conferma
	...
	+ Test lab → circostanziare che tipo di amiloide
	+ Test genetici → verificare alterazioni patologiche che danno amiloidosi come processo secondario
+ Tx → trattare patologia sottostante (se c'è) e spegnere infiammazione
	* Tto verso l'eziologia
	* Immunomodulazione: `colchicina`, `ciclofosfamide`
	* Tp. sostitutiva e/o di sostegno al bisogno

## Nefropatia in gestosi gravidica
* Quadro sdr che compare tipicamente nel III trimestre (raro e resistente in II), caratterizzato da
	* Ipertensione arteriosa
	* Proteinuria ed edemi declivi ("nefropatia gravidica")
	* Crisi convulsiva^[Prodromi: ++ cefalea, crampi addominali, ++edema] ⇒ (_"eclampsia"_)
* Pre-eclampsia nel 3--5% delle gravidanze, ma solo 0.05% ha reale valenza clinica (eclampsia)
	* Più tipico della primigravida (R x7 c/o multigravida), ma recidiva in 20% dei casi
	* Più tipico di gravidanze gemellari (R x5 c/o singoli)
	* Più tipico di gravida con comorbidità attinenti (diabete, trapianto, dialisi, ipertensione, IR, patologia gravidica, LES)
* Corteo SeS specifico
	* ↑ PA (sopratutto ↑ PAd)
	* Proteinuria
	* Edemi declivi
	* Tendenza all'iperuricemia
	* Dolore epigastrico
	* Iposomia del feto
* Tto: sintomatico e preventivo (__il vero trattamento__, che è risolutivo, è _rimuovere la placenta_, quindi __il parto__)
	* ABC e gestione dell'acuzia come appropriato
	* Agenti ipotensivanti e vasodilatatori

### Patogenesi
:::{.callout-note}
###### Processo di placentazione normale
Durante una normale placentazione, esiste una componente del feto, chiamata __sinciziotrofoblasto__, che entra in contatto con l’utero, più specificatamente con la decidua materna e le adiacenti arterie spiraliformi.

Le arterie spiraliformi attraversano il tessuto connettivo e arrivano fino ad uno strato di muscolatura liscia, che ne regola il flusso ematico mediante contrazione muscolare. Il contatto tra la circolazione materna e fetale porta i due sistemi vascolari ad una contiguità attiva. Il sincizio trofoblasto penetra la parete delle arterie e sostituisce parte dell’endotelio materno (in giallo nell’immagine),stimolando il rimodellamento della parete arteriosa in modo tale da sostituire la muscolatura liscia e mantenere dilatate le arterie.  I due sistemi entrano in circolazione e la madre, per la prima volta, prende rapporto con il sistema HLA del figlio. Il figlio eredita metà del patrimonio genetico dalla madre e l’altra metà dal padre. Nell’eventualità che, una volta cresciuto, dovesse donare un rene alla madre si avrebbe una reazione di rigetto nei confronti dell’organo perché ha un HLA diverso da quello della madre. Si sviluppa una reazione immunitaria contro l’organo del figlio, percepito dalla madre come estraneo. Questo fenomeno in questo caso non si verifica perché entra in gioco la tolleranza materno-infantile, meccanismo immuno-genetico di tolleranza per cui in un host potenzialmente innescante allo-reattività (madre), questa non si verifica.

Nella gravidanza normale avviene che la muscolatura dell’arteria intra-miometriale della madre viene rimpiazzata in maniera strutturale dalle cellule del feto. Queste cellule rimpiazzano le cellule muscolari lisce con una reazione flogistica che è la conseguenza del contatto materno-fetale. Nella decidua sono presenti macrofagi (in viola) e NK (in rosso) che autorizzano le cellule del feto a risalire lungo il percorso dell’arteria materna per modificarne la muscolatura liscia.  Queste cellule immunocompetenti facilitano l’invasione profonda del sincizio trofoblasto nel segmento miometriale e promuovono il rimodellamento estensivo delle arterie spiraliformi. Di fatto, attuano una risposta infiammatoria di tipo tollerogenico.

La madre si dimostra accogliente fin dalle prime fasi della gravidanza, tollera questo fenomeno perché deve evitare al feto traumi dovuti a ciò che lei svolge durante il giorno. Ad esempio, se la madre fa uno sforzo fisico, il feto non può subire una ischemia per vasocostrizione delle arteriole della placenta. Il feto toglie alla madre la possibilità di ridurre il flusso di sangue che arriva a lui stesso, questo è il motivo per cui la donna in gravidanza abbassa la sua pressione. La circolazione che arriva alla placenta porta circa il 20% della gittata cardiaca, questa è sottratta alle resistenze periferiche per questa azione di rimpiazzo che il feto fa nei confronti della madre per poter sostenere il suo processo di crescita. La pressione media della donna si abbassa perché una parte importante del flusso cardiaco viene veicolata in un distretto in cui le resistenze periferiche sono state rimosse. Il feto cerca di creare una condizione per cui il circolo, e quindi la possibilità di ossigeno e nutrimenti, e la vascolarizzazione rimanga costante indipendentemente dalla regolazione del flusso materno che cambia in base all’attività svolta dalla madre. Non solo, ma non avendo il controllo delle resistenze uterine la madre risulta molto meno sensibile anche all'angiotensina-II (si determina un effetto di shunt a/v talmente imponente da vanificare, di fatto, uno dei più potenti vasoattivi).
:::

* Essenzialmente: __inefficace o anormale placentazione__
	1. Ridotto sviluppo della tolleranza vs le strutture fetali, a causa di < invasione di cellule immunocompetenti^[Per genetica materna, __genetica paterna__ (interazione padre-madre), fattori infettivi, o __tutto quello che può interferire nel processo di placentazione__]
	2. Rimodellamento vascolare inefficace, con __incompleta sostituzione della muscolatura liscia perivascolare delle arteriole spiraliformi intramiometriali__
	3. La madre mantiene il controllo delle resistenze periferiche, nonché la sensibilità all'AG-II (risponde all'AG-II come se fosse non gravida
	4. ... (non ben compreso)
	5. Conseguenze su madre e feto
		* Madre: HELLP-sdr^[Hemolysis, Elevated Liver enzymes, Low Platelets)], endoteliopatia, coagulopatia, ↑ infiammazione ⇒ ipertensione, proteinuria, turbe SNC
		* Feto: stress ipossico

## Vasculiti
* Vasculite ::= patologia caratterizzata da __necrosi infiammatoria della parete vascolare nella sua interezza, oltre che del tessuto perivascolare__ [N.B: la microangiopatia invece è un quadro patologico causato dalla flogosi __del solo endotelio vasale__]{.aside}
* Patologie nel complesso rare
* Vasculite è patologia in cui si ha tipicamente un __lungo periodo prodromico__, dopo il quale si manifesta __improvvisamente una fase acuta__ (scatenata da un __evento trigger__ che determina improvviso sbilanciamento dell'omeostasi, con importante infiammazione)
* Tto dev'essere rapido, basato essenzialmente sullo spegnimento del quadro infiammatorio. L'aggressività (dosi e poli-tp.) va dosata in funzione della gravità e del rischio
	* 1/a linea: steroidi
	* 2/a linea: immunomodulatori (ciclofosfamide, azatioprina)
	* 3/a linea: -mab

:::{.callout-tip}
###### SeS comuni delle vasculiti
* Sintomi sistemici o prodromi (aspecifici e di lungo corso)
	* Febbre
	* Astenia, calo ponderale
	* Atralgie e mialgie migranti, artriti^[Perché tessuti articolari sono ben vascolarizzati, tanto che spesso artrite è prodromo di una vasculite]
	* Piccole foci di sanguinamento (emottisi, emoftoe, rinorragia, rettoragia, sanguinamenti corneali, gengivali...)
* Sintomi della fase acuta
	* ☆ Cute: __petecchie e porpora__, noduli, ulcerazioni
	* ☆ Rene^[Il rene è un organo che risente tanto delle vasculiti, perché la componente vascolare è specifica ed essenziale per la funzionalità d'organo: la rete mirabile arteriosa è ad alta pressione, e deputata alla filtrazione -- una perdita del letto vasale, di funzione così integrale, determina velocemente una perdita funzionale]: IR (tipicamente: improvvisa da AKI) per distruzione della componente vascolare del glomerulo
	* ☆ Resp: emottisi, infiltrati polmonari (per coinvolgimento del letto capillare polmonare)
	* ☆ G/I: dolore addominale, sangue nelle feci, fino ad ematemesi/melena
	* Neuro: neuropatia periferica
	* Inf: sinusite necrotizzante
:::

* Delle vasculiti coesistono 2 sistemi classificativi: in base all'eziologia o in base alla dimensione e tipo dei vasi colpiti
	* Classificazione morfologica
		* Vasculiti dei medi vasi (poliarterite nodosa, malattia di Kawasaki)
		* Vasculiti dei grossi vasi ("arteriti": arterite di Takayasu, arterite a cellule giganti)
		* Vasculiti ad interessamento variabile (malattia di Bechet, sdr di Cogan)
	* Classificazione eziologica
		1. Vasculiti pauci-immuni (ANCA^+^^[Ab Anti Citoplasma dei Neutrofili])
			* Poliangite microscopica ("MPA") [a _prevalenza_ pANCA^+^]
			* Granulomatosi con poliangite ("GPA"; anche "malattia di Wegener") [a _prevalenza_ cANCA^+^]
			* Granulomatosi eosinofila con poliangite ("EGPA"; anche "sdr di Churg-Strauss") [a _prevalenza_ pANCA^+^]
		2. Vasculiti da immunocomplessi
			* GN da Ab anti memrbana basale golmerulare
			* Vasculiti crioglobulinemiche ("CV")
			* Vasculiti da complessi ag-IgA ("IgAV")
				* Porpora (e nefrite) di Henoch--Shönlein
			* Vasculiti ipocomplementariemiche urticariale ("HUV", o "anti-C1q")

### Vasculiti pauci-immuni (ANCA-relate)

![](img/vasculiti.png)

:::{.callout-note}
###### ANCA
Per ANCA (Anti Neutrophil Cytoplasm Ab) si intende una famiglia di Ab diretti contro componenti del citoplasma dei neutrofili. Si trovano 2 tipi di pattern ab.:

1. cANCA ("pattern citoplasmatico") --- autoab diretti vs protienasi-3
2. pANCA ("pattern perinucleare") --- autoab diretti vs mieloperossidasi

Va detto che la positività p/c agli ANCA non è tipica strettamente solo delle vasculiti autoimmuni, sebbene sia molto più rappresentata in questo tipo di situazioni: c'è una quota di vasculiti che non presentano pattern di positività p o c, sebbene ci siano circolanti ab. vs i neutrofili. In queste vasculiti l'auto-ab. è diretto contro altri componenti del citoplasma dei neutrofili che non sono nè la proteinasi-3 né la mieloperossidasi, per questo vengono definite in modo confondente "vasculiti ANCA^-^", sebbene si trovino comunque altri ANCA circolanti.

Una quota di ANCA circolante è comunque fisiologica, ma sotto una determinata soglia la tolleranza globale verso gli auto-ag viene comunque conservata. Quando si ha un incremento di ANCA non più compatibile con il mantenimento della tolleranza vs gli auto-ag, _allora_ si crea patologia.
:::

#### Patogenesi
* Fase cronica (paucisintomatica)
	0. Predisposizione genetica e fattori ambientali
	1. Sviluppo degli ab. anti citoplasma dei neutrofili
* Fase acuta
	1. Evento trigger
		* Trigger infettivo (potenzialmente qualsiasi infezione che attiva i neutrofili)
		* Trigger ambientale (potenzialmente qualsiasi esposizione che determina ↑ infiammazione)
	2. Attivazione dei neutrofili che, nell'attività, rilasciano ag contro i quali si sviluppano auto-ab. ANCA (quando muoiono, quando degranulano e si aprono, quando fanno NETosi...)
	3. Legame tra ANCA-Ag e innescamento del processo autoimmunitario (prevalentemente da neutrofili)
	4. I neutrofili attivati determinano l'avvio della via alternativa del complemento (da C5a)
	5. Neutrofili attivati e complemento danneggiano la parete vascolare, necrotizzandola

#### Istologia ed a/p delle vasculiti ANCA-relate
* __Aspetto necrotizzante__ per __necrosi fibrinoide__ dei piccoli vasi
* Nella parete vasale e nella zona circostante si osserva franco stato infiammatorio (granulomi endo- e perivascolari)
* Formazione di tipiche strutture, dette "__crescents__", nella zona del glomerulo (dovute alla necrosi)
	* Crescents di tipo cellulare (reversibili): in fase acuta
	* Crescents di tipo fibroso (irreversibili): in fase cronica

	Le crescents schiacciano, distorcono e deformano il glomerulo, il quale perde funzione
* ★ Aspetto chiave: __fluorescenza sempre negativa__, perché non si ha deposito di anticorpi nella membrana basale del glomerulo, ma si ha un'azione autoimmune nello stroma vasale che si ripercuote sul glomerulo (essendo questo così dipendente dal buon funzionamento del vaso)

:::{.callout-tip}
###### Perché si chiamano vasculiti pauci-immuni se poi tutta la fisiopatogenesi è autoimmune?
Bella domanda; perchè frega. Vengono dette pauci-immuni perché alla fluo non si riscontra deposito di Ig nella membrana di filtrazione, ma il danno nelle vasculiti ANCA è dato dall'azione diretta dei _neutrofili_ attivati.
:::

#### Prognosi
* Prognosi collegata con aspetti istopatologici (quindi necessaria biopsia renale per definirla)
	* Prevalenti di lesioni focali → prognosi poco severa, perdita della funzione renale avviene ~7% dei casi (e solo nel 1aa)
	* Prevalenti crescents di tipo cellulare → a 5aa 25% pz. avrà IR per cui sarà necessaria dialisi
	* Prevalenti crescents di tipo sclerotico → a 1aa 50% pz. avrà IR (a 7aa solo 25% pz. avrà funzione renale conservata)
* Possibili recidive
* Un danno renale è tipicamente correlato ad un danno anche in altri distretti molto vascolarizzati (es: polmone)

### Vasculiti da immunocomplessi

#### Porpora (e nefrite) di Henoch--Schönlein {#phs}
* __Vasculite dei piccoli vasi non trombocitopenica, causata da depositi di IgA__ (con contestuale (glomerulo)nefrite)
* Triade sintomatica: febbre/artriti + coinvolgimento _prevalente_ di 3 sistemi specifici (cute, g/i, rene)
	* Cute: porpora cutanea con petecchie, specialmente aaii
	* G/i: coliche addominali, melena, ematemesi per vasculite locale. Intususcezione in casi gravi (2-3%)
	* Rene: IRA progressiva, spesso esordisce con macro-ematuria e proteinuria
* Tipicamente < 20aa
* Estremamente simile a GN da depositi di IgA (alcuni autori le ritengono la stessa entità patologica a diversi punti della storia naturale)
* Fluo renale pos per depositi di IgA (caratteristicamente definiti "depositi a zolle")

## Microangiopatie
* __Quadro patologico sistemico acuto caratterizzato da flogosi *del solo endotelio*__, che si può accompagnare ad anemia emolitica, piastrinopenia da consumo e MOF
* Nell'ambito delle microangiopatie il fenomeno essenziale è quello di __emolisi__: quello che produce flogosi endoteliale determina anche emolisi endovascolare
	* Anemia
	* Schistocitosi^[Schistociti = porzioni di eritrociti rotti] (normalmente assente)
	* ↑ LDH (per emolisi, è contenuta nei globuli rossi)
* 2 forme di microangiopatia essenziali
	1. Porpora Trombotica Trombocitopenica (anche "porpora di Moschowitz", o "PTT")
...
:::{.callout-tip}
###### PTT e SEU: due cose molto simili
La sindrome uremico-emolitica ha molte affinità con la porpora trombotica trombocitopenica o PTT, che mostrerebbe un quadro pressoché sovrapponibile; secondo alcuni autori, invece, nella SEU prevarrebbe la insufficienza renale, mentre nella PTT prevarrebbero i sintomi neurologici.
...
* __Microangiopatia in cui si ha anemia emolitica e piastrinopenia da consumo__
* Più tipica dell'adulto
* Fisiopatologia: __iperfunzione del fattore di von Willebrand__
	1. __Deficit di funzione di ADAMST-13__ --- ADAMST-13 è una metalloproteasi deputata all'inattivazione, mediante clivaggio, del fattore di von Willebrand
	2. __Il fattore di von Willebrand si trova permanentemente attivo__, potendo quindi reclutare piastrine per formare legami endotelio-piastrina e piastrina-piastrina
	3. Si crea un trombo piastrinico, sul quale poi andrà a montarsi la fibrina
	4. I filamenti di fibrina endovascolari si comportano da agente irritante e tagliente
		* Irritano l'endotelio ⇒ microangiopatia
		* Rompono meccanicamente gli eritrociti ⇒ emolisi e schistocitosi
* Il deficit di ADAMST-13 ha 3 cause: ↓ attività, ↓ concnetrazione o auto-ab.
	* ↓ dell'attività del fattore (riduzione funzionale su base tipicamente genetica)
	* ↓ della concentrazione (riduzione della produzione)
	* Inefficacia per un suo sequestro da parte di ab. anti-ADAMST13
* Clinica: spiegata essenzialmente dalla combinazione di microtrombosi ed anemia
	* Anemia emolitica
	* Trombocitopenia
	* Trombosi endovascolare
	* Complicanze
		* ★ Deficit di ossigenazione per anemia
		* AKI (per microtrombosi)
		* Impairment neurologico, fino a coma e danni permanenti (per microtrombosi)

#### Tto
* Contenere il problema trombotico
	* ASA o altri anti**aggreganti**
	* Anticoagulanti
* Supporto d'organo
* Capire come mai vWF non va e risolvere quello
		* Autoanticorpi? → PL-EX + tp. steroidea immunomodulatrice
		* Deficit genetico? → splenectomia

### Sdr emolitica--uremica
* Sdr sostanzialmente clinicamente identica alla PTT ma con una normale funzione di ADAMST-13. Questo perché l'iperfunzione di vWF arriva da altra causa (esogena che produce da iperattivazione del complemento)
* Più tipica del ped (spp SEU atipica)
* Clinica: triade di sintomi
	* Anemia emolitica
	* Trombocitopenia
	* AKI
* Si individuano essenzialmente 2 forme di SEU, in funzione del meccanismo che la induce
	* SEU tipica (<^[La sindrome emolitico tipica è stata scoperta nel 2006-2007 quando ci fu un’epidemia in Germania a causa di una proliferazione batterica di Shigella in acqua che coinvolse una grossa parte della popolazione con 54 casi con sindrome emolitico uremica. Fu identificata la Shigella con la rispettiva Shiga-toxin che è in grado di produrre l’attivazione cospicua del complemento. Venne definita forma di sindrome emolitica classica, che in realtà è la meno frequente rispetto a quella alternativa.]) → la causa determinante è esogena e determina un'iperattivazione del complemento (tipicamente tossina batterica, es _Shigella dysenteriae_)
	* SEU atipica (>) → c'è un'instabilità intrinseca del sistema di controllo del complemento
* Fisiopatologia: __iperattivazione del complemento per causa esogena o endogena determina contestualmente un danno endoteliale massivo, che espone massivamente il vWF e determina un massivo reclutamento piastrinico__ (e da qui la clinica tipica della microangiopatia PTT)
* Tto: `eculizumab` per bloccare C5, PLEX, sostegno d'organo

## IVU

:::{.callout-tip}
###### Aspetto classico delle urine in IVU
* Piuria
* Odore di ammoniaca (N prodotto dai batteri)
* pH tendenzialmente basico (> 7). Se pH acido (< 5): sospettare TBC
* Leucociti ++/+++
:::
* SeS tipico è disuria: __stranguria__, pollachiuria, tenesmo, ...
* FdR: residuo urinario post-minzionale, sesso F, gravidanza, scarsa igiene, glicosuria, azione iatrogena, ricoveri H, catetere vescicale/ureterale^[R > per ogni g di cateterizzazione], pannolone
* Approccio dx: APP, esame urine std (o dip-stick), urinocoltura ± ABG
* Morg tipici: dipende da contesto, ma tendenzialmente batterico (in immunocompetente)
	* In pz. comunitario: _**E coli**_ (fino a 95%), _Klebsiella spp_, _Proteus mirabilis_, _Pseudomonas aeruginosa_
	* In pz. H: _**E coli**_ (50%), Gram^neg^ (_Klebsiella, Proteus, Enterobacter, Pseudomonas e Serratia_), Gram^pos^ (_E. faecalis, Staph saprophyticus e Staph aureus_). Più frequenti infezioni fungine, che nel contesto comunitario invece riguardano tendenzialmente pz. immunocompromessi
* 3 pilastri generici di tto:
	* Idratazione
	* Analgesia
	* Iniziale abx empirico (`fosfomicina` x1 per 3g). __Sse ricorrenti o resistenti: abt mirato__

:::{.callout-note}
###### Aumento del rischio per IVU in gravidanza
* ↓ peristalsi ureterale distale per progesterone
* Possibile reflusso vescico-ureterale per compressione dell'utero
* Proteinuria e glicosuria sono più probabiòi
:::


:::{.callout-warning}
###### Manovre iatrogene nelle vvuu post-infezione: attenzione al timing per non rischiare nuova infezione iatrogena
Qualsiasi manovra iatrogena post IVU __deve aspettare almeno 3 mesi dall'ultima infezione__ (e comunque con atb-profilassi), altrimenti si rischia di causare diffusione batterica ascendente
:::

### Cistite
* IVU > comune (generalmente F >> M, tranne in anziano per IPB)
* Sintomatologia molto variabile (da batteriuria asintomatica ad infezione sintomatica)
* Il rischio di cistite è correlato con età

	![](img/cistiti.png)
	* La batteriuria asintomatica ha frequenza > con età
	* L'infezione sintomatica ha picchi di frequenza ad età specifiche
		* Prescolare (F > M)
		* Inizio attività sessuale (F > M)
		* Gravidanza (_ehm..._)
		* Anziano (M > F)
* Morg tipici: Gram^neg^ (raggiungono vvuu per via ascendente a partenza prevalentemente fecale, secondariamente cutanea)

### Ureterite
* IST del tratto terminale dell'uretra
* Morg: __gonococco__, __Clamidia__, Ureaplasma


### Pielonefrite (nefropatia interstiziale batterica)
* __Nefropatia interstiziale__ (acuta o cronica) __causata da presenza di batteri nel parenchima renale__
* Colonizzazione patogena per via ascendente (IVU trascurata) oppure _ematogena_
* FdR specifici: tutto quello che "lava" meno l'interstizio renale rendendolo più ospitale per i batteri
	* Ostruzione meccanica al flusso (calcolo, reflusso ureterale, vescica neurogena)
	* ↓ flusso ematico
	* Bassa tensione di O~2~ locale
	* Produzione locale di ammonicaca, pH basso
	* Diabete
	* Età
	* Farmaci (FANS, cortisonici, ...)
* Tto: deve essere mirato al patogeno
	* Atb mirato da ABG
	* Tp. di sostegno sintomatico
	* Eliminare fattori causali se pielonefrite è cronica

#### Pielonefrite acuta
* Ci sono 3 sintomi chiave che permettono di fare ddx con altre IVU:
	* Febbre elevata (> 39, brivido scuotente)
	* Dolore anche lombare
	* Disuria (comune a tutte le IVU)
* Se danno renale è importante si può avere screzio degli indici renali
* Se ci sono ascessi, si vedono bene ad img (anche POCUS, altrimenti TC)

#### Pielonefrite cronica
* Condizione paucisintomatica e di lunga durata di pielonefrite
	1. __Forma ostruttiva__ (da ridotto efflusso della materia urinaria infetta per ostruzione)
		* Cause: calcolosi, IPB, da legatura iatrogena degli ureteri, neoplasia che comprime ab. extrinseco
	2. __Forma da reflusso vescico--ureterale__ (da risalita di urina infetta negli ureteri durante la minzione per alterazione, spesso congenita, della valvola vescico--ureterale)
		* La gravità del reflusso può essere stadiata tramite cistografia
		
			![](img/cistografia-reflusso.png)
		* Spesso la causa del reflusso è anatomica: l'uretere è corto e impiantato in una posizione che favorisce la risalita (molto orizzontale attraverso la parete vescicale
* Clinica: molto variabile, spesso progressiva e silente
	+ Poliuria
	+ Anemia
	+ Ipertensione
	+ SeS di IR, anche avanzata
	+ Lab: leucocituria, proteinuria, urinocoltura +
	+ Biopsia al FN: parenchima renale con molto infiltrato infiammatorio, tubi ripieni di materiale amorfo
...
:::{.callout-important}
###### Indicazioni strette alla dialisi
* Iper idratazione clinicamente significativa e non correggibile
* IperK
* ↑ urea
* Acidosi clinicamente sifnificative
:::
