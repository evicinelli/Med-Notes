...
![(1) circolo normale; (2) HF sx; (3) HF biventricolare; (4) HF dx](img/scompenso-cardiaco-fisiopatologia.png)
...
![Tendenza da parte del sistema nervoso simpatico, in caso di ipoperfusione, ad innescare una vasocostrizione nei tessuti periferici con l’obiettivo di recuperare una pressione sufficiente. Questo tipo di reazione può aumentare la pressione dei vasi più grandi ma non permette più la perfusione del microcircolo distale che viene danneggiato. Il danno andrà a richiamare cellule infiammatorie che danneggiano ulteriormente il microcircolo](img/shock-fisiopatologia-lesioni.png)  
...
- La diagnosi deve essere di esclusione: bisogna sicuramente escludere la dissezione con angioTC con mdc (nella quale l'ematoma si evidenzia bene^[![Ematoma intramurale (H)](img/ematoma-intramurale.png]
- Terapia: osservazionale e di supporto
	- Obiettivo: ↓ PA per permettere una scomparsa + riassorbimento dell'ematoma (`vasodilatatori`)
...
- Imperativo Capire se la dissezione è di tipo A o B, per capire come conviene procedere
	...
	![](img/mortalita-management-ad.png)^[NB: sono sempre condizioni con mortalità che bene che vada non si abbassa oltre l'8--10% a 30gg, quindi comunque siamo nella caccona]
