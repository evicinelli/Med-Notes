...
| Febbre ondulante                       | Periodi febbrili lunghi (fino 14gg) con oscillazioni consistenti seguiti da periodi più brevi di apiressia. Defervescenza per lisi                                                                                                                                              | ![](img/febbre-ondulante.png)  | Tipica di infezioni da _Brucella_                                                                                                                                                                                                                                         |
| Febbre ondulante da linfoma di Hodgkin | Febbre grossolanamente ondulante ma con frequentissima variabilità di temperatura (perché moltissimi fattori^[Necrosi, citochine, infezioni intercorrenti] concorrono alla febbre tumorale). Andamento definito a spike                                                         | ![](img/febbre-ondulante.png)  |                                                                                                                                                                                                                                                                           |
| Febbre continua                        | Periodo continuo di piressia con oscillazioni giornaliere modeste (≤ 1°C). Cade per crisi                                                                                                                                                                                       | ![](img/febbre-continua.png)   | _Diplococcus pneumoniae_                                                                                                                                                                                                                                                  |
