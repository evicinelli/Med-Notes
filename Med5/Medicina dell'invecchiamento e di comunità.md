...
* I vecchiettə, fisiologicamente, passano da una situazione di buona salute → rischio → menomazione → fragilità → disabilità
...
### Medicina di genere nell'anziano
...
* VMD ha obiettivo di ricercare i problemi "grandi" del pz. geriatrico, per individuare puntualmente i suoi __bisogni__ e produrre un __programma d'intervento__ rispetto a tali bisogni
...
#### Indici per la valutazione delle capacità cognitive
...
### Classificazione della demenza in base all'eziologia
...
* Modificazione del comportamento e della personalità
...
### FdR e prevenzione (secondo @Livingston_2020) {#fdrdemenza}
1.  Scarsa educazione
2.  Ipertensione
...
* Risolvere FdR o limitarne l'impatto
...
### Valutazione del paziente con sospetto di sarcopenia
...
* Osteoporosi è primaria vs secondaria (>)
...
#### Riabilitazione motoria del pz. osteoporotico con fratture vertebrali
...
3. Fase di ricondizionamento e riabilitazione generica _continuativa_ e con intensità appropriata

[^ortesirigidevselastiche]: Le ortesi rigide vanno messe a seguito di frattura, perché stabilizzano meglio. Tuttavia

	* Sono scomode, particolarmente in alcuni pz. (addome prominente, scoliosi/cifosi/lordosi molto importanti)
	* In caso di deformità gravi creano intercapedini tra ortesi e paziente che non è funzionale (anzi, fa peggio)

	Ci sono alternative semirigide o elastiche, che tuttavia supportano meno la colonna e risultano meno indicate per _correggere_ un difetto. Vanno considerate quando quelle rigide non sono applicabili. Seguire un approccio personalizzato centrato sulle necessità individuali del paziente. Mai ortesi da sola, sempre associata a piano di fkt (con intensità e posologia appropriate)

### Riabilitazione del pz. a seguito di ictus {#rehab-ictus}

:::{.callout-note}
###### Indici prognostici negativi per il recupero funzionale
* Pz. anziano
* Pregressi ictus
* Danno sfinteriali
* Emiagnosia visiva, percettiva, spaziale
* Paralisi severa
* Scarso recupero intrinseco
	* Non recupero della sensibilità entro 2--4 mesi
	* Comparsa tardiva dei segni iniziali di recupero motorio (> 3--6 mesi)
* Inizio tardivo della riabilitazione
:::

* Finestra riabilitativa: +3--6 mesi, dopo 1aa il recupero non è più verosimile (sequele permanenti)
* Distinguiamo un recupero funzionale *intrinseco* (dovuto al ripristino delle strutture danneggiate, risoluzione dell'edema, riorganizzazione e plasticità neuronale) da quello *estrinseco* (pz. viene allenato da professionista a compensare la funzione menomata)
* L'obiettivo riabilitativo è quello di __massimizzare il recupero estrinseco__
	...
	* Incentivare il recupero neurologico della motilità volontaria tramite stimolazione neuromotoria
		...
		* Rimozione delle sinergie muscolari
		* Ripresa della deambulazione
	* Insegnare strategie di compenso che permettano di ridurre la disabilità
	* Strategie di mantenimento sul lungo termine per auto--gestione della motricità
* Intensificare progressivamente il programma fkt, mano a mano che clinica lo consente
...
## Patologie da cedimento della parete addominale
...
* Piede geriatrico (MFR)
* Trapianto d'organo in pz. anziano (DBD/DCD, trapianto fegato e rene, indicazioni, score, stratificazioni, tecnica ch, prognosi)
