...
\renewcommand{\a}[1]{\textcolor{Sepia}{\underline{\textsc{#1}}}}
...
% Note a margine e figure
\let\oldmarginnote\marginnote
\renewcommand{\marginnote}[1]{\oldmarginnote{$\longleftarrow$ \emph{#1}}}
\newcommand{\marginfig}[1]{\oldmarginnote{\textsf{Vedi \textbf{Figura \ref{#1}}}}}
\newcommand{\fig}[1]{\textsf{Vedi \textbf{Figura \ref{#1}}}}
