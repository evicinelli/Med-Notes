...
SIRS^[Systemic Inflammatory Response Sdr]
...
> | GCS ≤ 14 o eq. | +1 |
> 
> : Quick SOFA (qSOFA). 2+ ⇔ aumentato R/ per vita
...
### Suddivisione dei Morg patogeni
...
* Perno è __esame del liquor__ (rachicentesi da fare in ogni pz. sospetto per meningite, a meno di spp controindicazioni)
	...
	: Caratteristiche del liquor ottenibili con ispezione o esami di I livello
...
> In malati con interazione morg--host sfavorevole (alta virulenza, host debilitato, ↑ r/, SI ipoergico):
>
...
> ###### 🔴 Agenti eziologici di CAP grave (adu immunocompetente)
>* Strepto penumoniae
...
### Diarrea batterica da *Staph aureus*
* Serbatoio: uomo (cute)
* 5 serovar (A--E)
...
> ###### [LRINEC Score](https://www.ncbi.nlm.nih.gov/pmc/articles/PMC9267597/)
>
>| Item | Score |
>|---|-|
>| PCR > 15   | +4 |
...
> In forma cutanea, sierologia su sangue è neg; bisogna cercare parassita nelle lesioni
...
###### Febbre bottonosa (tifo da zecche del Mediterraneo)
...
| Esantema | o/ (gg) | q/ | progressione r/ |
|-|-|---|-|
...
* u/: coinvolgimento organico
	...
	* u/cardio : alterazioni del ritmo, miocarditi
...
#### Scarlattina (_Strepto pyogenes_)
...
###### Tto
* Atb x 10gg (__`amoxi`__, `macrolide`, __`cefalosporina/III`__)

#### Esantema critico (sesta malattia, HHV-6)
* Malattia infettiva da infezione di HHV-6~A|B~^[Human Herpes Virus 6] tipica dei primi 2aa di vita (tipo B) o in sg. immunodepressi (tipo A, da riattivazione)
* Come tutti HHV rimane latente in organismo (lfc e cellule epiteliali)
* Trasmissione: airborne
* Incubazione: 2w

###### Epidemiologia
* Endemica in tutto il mondo (autunno--primavera)
* Casi sporadici
* Incidenza 6--18, max 24m
* 

###### Clinica
* S/
	1. Febbre (compare e scompare per crisi → a volte convulsioni), malessere. Rinorrea, faringodinia. Linfadenomegalia (laterocervicale, retroauricolare, occipitale). Talvolta meningite, più spesso meningismo con fontanelle tese
	2. Esantema maculo papuloso rosa tenue (1--2gg)
* U/: rari, spp in immunodepresso
	* Riattivazione dell'infezione con sdr simil--mononucleosica
	* Polmonite intestiziale, epatite, encefalite

###### Dx
* PCR su saliva o sierologia

###### Tto
* Sintomatica
* Considerare `foscarnet` in immunodepresso

#### Megaloeritema infettivo (quinta malattia)
* Malattia da infezione di parvovirus B19
* 2--12aa
* Decorso autonomo e benigno, tranne in immunodepressi
* Virus ha tropismo in particolare per i precursori eritroidi

###### Clinica
* S/
	* Febbre, malessere, a volte artrite
	* Esantema maculo--papuloso "a farfalla" sul volto, poi corpo
* U/ tendenzialmente solo in immunodepressi
	* u/emato: Crisi aplastica, anemia, ipoplasia midollare cronica
	* ⚠ u/feto: idrope fetale a seguito di trasmissione in II semestre (generalmente letale)
	* u/reumato: poliartropatia simmetrica
	* u/varie: miocardite, epatite, vasculite, encefalite, sdr GB

###### Dx
* Dimostrazione eziologica con PCR o sierologia/IgM, IgG

###### Tto
* Sintomatico
* In immunodepressi: considerare Ig EV

#### Varicella (VZV^[HHV-3])
* Malattia acuta virale altamente contagiosa, 90% in ped < 6aa
* Ubiquitaria ed endemica in tutto il mondo

###### Storia naturale
1. Contagio airborne ed incubazione (10--23gg)
2. Replicazione nelle cellule nasali. Diffusione ematica e linfatica (prima viremia)
3. Raggiungimento degli organi bersaglio: polmone, sistema RE (seconda viremia → esantema)

###### Clinica
* S/
	* Febbre alta, malessere
	* Esantema __asincrono__ (patognomonico): macule → papule → vescicole → croste

* U/
	* Impetiginizzazione delle lesioni (sono pruriginose)
	* Polmonite interstiziale con infiltrati nodulari
	* Cerebellite (atassia)
	* Epatite acuta
	* GN
	* CID, SS, fascite necrotizzante

###### Dx
* Clinica spesso sufficiente
* PCR o sierologia se dubbio

###### Tto
* supportivo
* `acyclovir` in immunodepressi (< 24--48h da esantema)

###### Profilassi
* Vaccino a virus vivo attenuato (12-18m, 6aa)
* Richiamo a ~60aa per *prevenire* Zoster in Anz (vaccino differente, ricombinante). Inefficace in fase acuta o dolore neuropatico

>###### Zoster
> L'herpes zoster (fuoco di Sant'Antonio) è una mala†a infettiva causata da una riattivazione del virus Varicella Zoster che si manifesta tipicamente in soggetti anziani o immunodepressi con una __dermatite vescicolosa acuta unilaterale__ (tipicamente sul torace) associata a dolore e arrossamento distribuito lungo tutto il decorso del nervo (⇒ __rispetta i dermatomeri__). Spesso sono presenti‚ anche perdita di sensibilità e paralisi motoria. Il dolore neuropatico può perpetuare nel tempo e dare una nevralgia post-erpetca di tipo cronico insensibile ai trattamenti antivirali, ma parzialmente responsiva ai neurolettici. In Europa il 95% degli adulti è sieropositivo per VZV, di questo almeno 1/4 va incontro a riattivazione con sviluppo di herpes zoster sia in età anziana che in situazioni di immunodepressione. In Italia si verificano circa 6 casi ogni 1000.
>
> La malattia si localizza lungo tutti i metameri, specialmente in quelli toracici e nel territorio di distribuzione del nervo trigemino a livello craniale, ma anche a livello cervicale, lombare e sacrale. Inizialmente si presenta con eritema, dolore e calore cutanei seguiti poi da lesioni cutanee maculo-papulose che evolvono in vescicole, pustole e croste. L’esantema cutaneo è unilaterale e circoscritto ai dermatomeri corrispondenti all'area di innervazione del ganglio sensitivo interessato. Altri sintomi possono essere febbricola, cefalea, malessere, astenia e artromialgie; la risoluzione avviene in 2-4 settimane.
>
> Tto: `acyclovir` e `gabapentin`. Vaccino per prevenire.


#### Malattia erpetica
* Patologia post infezione HSV
	* HSV-1 → airborne (infezioni orali)
	* HSV-2 → sex, verticale (infezioni genitali)
* Come altri Herpesvirus l'infezione è permanente (localizzazione in gangli nervosi come VZV)

###### Storia naturale
0. Contatto
1. Replicazione iniziale in epidermide e derma vicino alla sede di contatto (fase attiva con lesioni cutanee)
2. Migrazione centripeta lungo le fibre nervose e stasi in gangli nervosi (fase latente^[DNA episomale e trascrizione virale estremamente ridotta])
3. Se riattivazione: migrazione centrifuga verso dermatomero di competenza del ganglio in cui il virus dormiente si era stabilito

###### Clinica
* S/
	* HSV1: lesioni orali (labbra >> faringite, enantema in cavo orofaringeo
	* HSV2: lesioni genitali
* U/
	* Possibile febbre e malessere se > coinvolgimento sistemico
	* Possibile forma oculare (congiuntivite, [cheratite dendritica](https://www.msdmanuals.com/it-it/professionale/disturbi-oculari/patologie-corneali/cheratite-da-herpes-simplex))
	* Possibile interessamento SNC (encefalit. Vescicolee erpetica ⚠)
	* Possibile forma generalizzata

> ###### Trasmissione periparto
* Herpes genitale in fase attiva (= vescicole erpetiche all'EO) è probabilmente trasmesso al neonato: in questo caso si fa cesareo

###### Tto
* `aciclovir`, `valaciclovir` se r/b è favorevole

### Infezione da HIV e AIDs

AIDS
: fase sintomatica avanzata dell'infezione da HIV, durante la quale si ha ↓/✗ SI (# Thelp CD4^+^ < 200/mm^3^)

###### Epidemiologia
* Diffusa, ma è sindemia: 38M sono HIV^+^ (90% in paesi a basso SEI; particolarmente in Africa)
* Ogni anno: +1.5M
* Morti in ↓↓ grazie a tto antiretrovirale
* Ad oggi le nuove infezioni caratterizzano spp YA
* Ita: +3.5K infezioni/anno

###### Trasmissione

| Liquido biologico | Carica virale |
|-|-|
|Sangue | +++ |
| Sperma | ++ |
| Secrezioni vaginali | ++ |
| Urine, feci, | + |
| Saliva, lacrime, sudore | + spesso insufficiente |

| Singola esposizione | Rischio di trasmissione |
|-|-|
| Puntura con ago | < 1% 
| Sex non protetto | < 3% |
| Materno--fetale | ~ 40% |
...
* __Ad oggi, la via d'infezione preferenziale è sex__ (parenterale ↓↓)
* ~ 80% sg. HIV^+^ è consapevole (grave!!)

###### Storia naturale
0. Contagio
1. HIV colonizza le cellule per cui ha maggior tropismo: __Thelp__ (CD4^+^)
	* Pericapside si fonde con membrana cellulare
	* Core entra in citoplasma, dove libera RNA ed enzimi replicativi
2. __RNA viene retro-trascritto a dsDNA__ (grazie a __trascrittasi inversa__; dsDNA viene __integrato__ nel genoma del Thelp
3. da dsDNA integrato si forma mRNA virale sfruttando il macchinario di trascrizione cellulare. mRNA migra in citoplasma
4. da mRNA virale si trascrivono le proteine che, in combinazione con mRNA direttamente codificante, servono per assemblare nuovi virioni
5. I virioni evadono dai Thelp e infettano altre cellule: l'infezione si espande. Si ha ripercussioni sulla competenza immunitaria in ~10aa (se non tto)

	![Relazione tra # CD4, # copie/ml e competenza immunitaria (senza tto)](img/hiv-sn.png)

> 🔴 Esistono pz. che hanno forme particolari:
>
>* __fast progressors__ (5--10%) --- l'infezione progredisce rapidamente tale da portare ad immunosoppressione in 1--2aa
>* __long term non-progressor__ (5--10%) --- conta CD4 permane stabile, carica virale bassa anche > 10--15aa


###### Dx
0. Non c'è reale clinica; __spesso il primo sintomo è infezione opportunistica^[Candidosi esofagea, criptosiporidiosi, polmonite da _Pneumocystis jirovecii_, criptococcosi, toxoplasmosi, infezioni da CMV o HSV gravi, sarcoma di Kaposi...]__. In 50% dei casi in corrispondenza dell'infezione: sdr virale acuta con s/ generici che, misconosciuta, si autorisolve in 1--4w
1. qpCR/HIV-RNA (per determinare: presenza e viremia in termini di copie virali/mL)
2. Conta dei lfc T CD4^+^ (per determinare competenza immunitaria)

	![Relazione tra CD4 e infezioni opportunistiche. __< 200 cellule/μl permette già di porre il sospetto dx di AIDS__. Sotto questa soglia si verificano quelle specifiche infezioni opportunistiche che sono altamente suggestive per AIDS, e spesso sono primo trigger per ordinare la conta linfocitaria](img/cd4-aids.png)

###### Tto

>###### U = U
> [Undetectable = Untransmittable (U=U)](https://en.wikipedia.org/wiki/Undetectable_%3D_Untransmittable) is a message used in HIV campaigns. It means that if someone has an undetectable viral load, they cannot sexually transmit HIV to others. U=U is supported by numerous health groups and organisations worldwide, [including the WHO](https://preventionaccess.com/). The validity of U=U has been proven through many clinical trials involving thousands of couples. U=U is also used as an HIV prevention strategy: if someone is undetectable, they cannot pass it further and hence, prevent the virus from spreading. This is known as Treatment as Prevention (TasP).

* Un buon tto permette una vita sostanzialmente normale, in termine di sopravvivenza e potenzialità (__U^[Sensibilità del test: 20 copie/mL] = U__)
	* Tto va iniziato asap
	* Carica virale viene soppressa dopo almeno 3--6m
	* Tto va preso a vita (compliance è mandatoria per successo^[Ci sono regimi posologici con farmaci IM __long acting__ che vanno presi q8w! In sviluppo farmaci q6m. A livello pratico non sono ancora soluzioni diffuse])
	* Monitorare regolarmente profilo epatico, renale, emocromo, *carica virale*
* Tto efficace è tto combinato (cART -- Combined Anti-Retroviral Therapy), per minimizzare potenzialità di resistenza (è retrovirus: geneticamente instabile)
	* Inibitori nucleosidici della trascrittasi inversa (NRTI)
	* Inibitori non nucleosidici (NnRTI)
	* Inibitori dell'integrasi
	* Inibitori della proteasi
	* Inibitori della fusione/ingresso (nuovi!)

###### Profilassi
* PREP
	* `truvada ®`^[ Truvada è il nome commerciale di un farmaco basato su un'associazione a dose fissa di due farmaci antiretrovirali, emtricitabina 200 mg e tenofovir disoproxil 300 mg. <https://it.wikipedia.org/wiki/?curid=3574926>]

	* Riservata a sg. a rischio: chi ha partner HIV^+^, std recente, elevato # partner, non uso di contraccettivi barriera, sex worker
* PEP
	* _Deve_ iniziare < 48h PE per avere sufficiente efficacia
	* cART x 4w sotto stretta sovreglianza
	* Prevede anche test HIV a t~0~, t~45gg~, t~90gg~
* TasP (U=U)
